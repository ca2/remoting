...
const TCHAR LogNames::SERVER_LOG_FILE_STUB_NAME[] = _T("remoting_node");
...
const TCHAR LogNames::WIN_EVENT_PROVIDER_NAME[] = _T("remoting_node");
...
const TCHAR ServiceNames::TVNCONTROL_START_REGISTRY_ENTRY_NAME[] =
  _T("tvncontrol");
const TCHAR ServiceNames::SERVICE_NAME[] = _T("remoting_node");
