...
#include "remoting/remoting/desktop/ScreenCapture.h"
...

{
   ...
   class CLASS_DECL_REMOTING_WINDOWS WindowsGraphicsCapture : virtual public ::remoting::ScreenCapture
   {
   public:
      ...
      // brga8
      virtual void on_frame(::remoting::bitmap * pbitmap);
