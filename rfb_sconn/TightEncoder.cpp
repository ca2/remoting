...
bool TightEncoder::shouldPackPixels(const ::innate_subsystem::PixelFormat & pf) const
{
...
void TightEncoder::packPixels(unsigned char *buf, int count, const ::innate_subsystem::PixelFormat & pf)
{
