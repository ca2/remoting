...
protected:
  ...
  void sendSolidRect(const ::int_rectangle &  r, const ::subsystem::FrameBuffer *fb);
  ...
  bool shouldPackPixels(const ::subsystem::PixelFormat & pf) const;
  ...
  static void packPixels(unsigned char *buf, int count, const ::subsystem::PixelFormat & pf);
  ...
  template <class PIXEL_T>
    void fillPalette(const ::int_rectangle &  r, const ::subsystem::FrameBuffer *fb, int maxColors);

  // Copy pixel data from the frame buffer to a byte array.
  template <class PIXEL_T>
    void copyPixels(const ::int_rectangle &  rect, const ::subsystem::FrameBuffer *fb, unsigned char *dst);
  ...
  template <class PIXEL_T>
    void encodeMonoRect(const ::int_rectangle &  rect, const ::subsystem::FrameBuffer *fb,
  ...
  // FIXME: Do not use DataOutputStream, do not throw ::io_exception.
  template <class PIXEL_T>
    void encodeIndexedRect(const ::int_rectangle &  rect, const ::subsystem::FrameBuffer *fb,
                           DataOutputStream *out);
