...
#define CLASS_DECL_REMOTING_RTC_WINDOWS CLASS_DECL_EXPORT
#else
#define CLASS_DECL_REMOTING_RTC_WINDOWS CLASS_DECL_IMPORT
#endif


//#include "remoting/remoting_rtc_windows/desktop/_.h"
