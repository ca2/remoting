...
#include "remoting/remoting_rtc_windows/desktop/Win8ScreenDriverImpl.h"
...
namespace remoting_rtc_windows
{
   ...
   //
   // Win8ScreenDriverImpl::Win8ScreenDriverImpl(::subsystem::LogWriter * plogwriter, ::remoting_rtc::UpdateKeeper *pupdatekeeper,
...
//   m_pupdatekeeper(pupdatekeeper), m_pupdatelistener = pupdatelistener;, m_plogwriter(plogwriter),
   ...
   void Win8ScreenDriverImpl::initialize_win8_screen_driver_impl(::subsystem::LogWriter * plogwriter, ::remoting_rtc::UpdateKeeper *pupdatekeeper,
                                           lockable_critical_section *pcriticalsectionFramebuffer, ::remoting_rtc::UpdateListener *pupdatelistener,
                                           bool detectionEnabled)
    {
   ...
   void Win8ScreenDriverImpl::initDxgi()
   {
      ...
      ::remoting_rtc::Region virtDeskRegion;
   ...
   void Win8ScreenDriverImpl::onFramebufferUpdate(const ::remoting_rtc::Region & regionChanged)
   {
   ...
   void Win8ScreenDriverImpl::updateCursorShape(::remoting_rtc::CursorShape *pcursorshapeTarget)
   {
      critical_section_lock al(&m_cursorMutex);
