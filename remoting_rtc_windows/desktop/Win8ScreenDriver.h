...
#include "remoting/remoting_rtc_windows/desktop/CopyRectDetector.h"

namespace remoting_rtc_windows
{

   class CLASS_DECL_REMOTING_RTC_WINDOWS Win8ScreenDriver :
   ...
   public:
      ...
      //Win8ScreenDriver(::remoting_rtc::UpdateKeeper * pupdatekeeper, ::remoting_rtc::UpdateListener * pupdatelistener, lockable_critical_section *pcriticalsectionFramebuffer,
   ...
   private:
      ...
      ::remoting_rtc_windows::CopyRectDetector m_pcopyrectdetector;
