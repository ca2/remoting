...
#include "remoting/remoting_rtc_windows/desktop/Win32MirrorScreenDriver.h"
...
namespace remoting_rtc_windows
{
   ...
   Win32ScreenDriverFactory::Win32ScreenDriverFactory()
   {
      ...
      //::remoting_rtc_node::ServerConfig *pserverconfig) : m_pserverconfig(pserverconfig) {}

   Win32ScreenDriverFactory::~Win32ScreenDriverFactory() {}

   void Win32ScreenDriverFactory::initialize_screen_driver_factory(::remoting_rtc_node::ServerConfig *pserverconfig)
   {
   ...
   ::pointer < ::remoting_rtc::ScreenDriver > Win32ScreenDriverFactory::createScreenDriver(
   ...
   ::pointer < ::remoting_rtc::ScreenDriver > Win32ScreenDriverFactory::createStandardScreenDriver(
      ::remoting_rtc_node::Configurator * pconfigurator,
      ::remoting_rtc::UpdateKeeper *pupdatekeeper,
      ::remoting_rtc::UpdateListener *pupdatelistener,
      ::innate_subsystem::Framebuffer *pframebuffer,
   ...
   ::pointer < ::remoting_rtc::ScreenDriver > Win32ScreenDriverFactory::createMirrorScreenDriver(
      ::remoting_rtc_node::Configurator * pconfigurator,
      ::remoting_rtc::UpdateKeeper *pupdatekeeper,
      ::remoting_rtc::UpdateListener *pupdatelistener,
      ::innate_subsystem::Framebuffer *pframebuffer,
