...
namespace remoting_windows
{
   ...
   void Win32ScreenDriverBaseImpl::initialize_screen_driver(::remoting_rtc_node::Configurator * pconfigurator, ::remoting_rtc::UpdateKeeper * pupdatekeeper,
   ...
   const ::remoting_rtc::CursorShape *Win32ScreenDriverBaseImpl::getCursorShape() { return m_pcursorshapegrabber->getCursorShape(); }
