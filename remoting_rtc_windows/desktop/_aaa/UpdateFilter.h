...
namespace remoting_rtc_windows
{
   ...
   {
   public:
      //UpdateFilter(::remoting_rtc::ScreenDriver *screenDriver, ::innate_subsystem::Framebuffer *pframebuffer,
        //           lockable_critical_section *framebufferCriticalSection, ::subsystem::LogWriter * plogwriter);
      UpdateFilter();
      ~UpdateFilter();

      virtual void initialize_update_filter(::remoting_rtc::ScreenDriver *screenDriver, ::innate_subsystem::Framebuffer *pframebuffer,
             lockable_critical_section *framebufferCriticalSection, ::subsystem::LogWriter * plogwriter);

      void filter(UpdateContainer & updatecontainer);

   //private:
      void getChangedRegion(::remoting_rtc::Region & rgn, const ::i32_rectangle & rectangle);
      void updateChangedRect(::remoting_rtc::Region & rgn, const ::i32_rectangle & rectangle);
      void updateChangedSubRect(::remoting_rtc::Region & rgn, const ::i32_rectangle & rectangle);
      ...
      ::remoting_rtc::ScreenDriver *m_pscreendriver;
