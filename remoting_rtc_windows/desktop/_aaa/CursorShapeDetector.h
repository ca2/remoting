...
namespace remoting_rtc_windows
{
   ...
   public:
      ...
      virtual void initialize_cursor_shape_detector(::remoting_rtc::UpdateKeeper * pupdatekeeper, ::remoting_rtc::UpdateListener * pupdatelistener, CursorShapeGrabber *pcursorshapegrabber,
