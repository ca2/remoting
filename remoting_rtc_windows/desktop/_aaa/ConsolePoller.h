...
namespace remoting_rtc_windows
{
   ...
   public:
      ...
      virtual void initialize_console_poller(::remoting_rtc::UpdateKeeper * pupdatekeeper, ::remoting_rtc::UpdateListener * pupdatelistener, ScreenGrabber *pscreengrabber,
