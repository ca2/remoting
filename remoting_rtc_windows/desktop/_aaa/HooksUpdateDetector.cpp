...
//    }
   ...
   void HooksUpdateDetector::initialize_hooks_update_detector(::remoting_rtc::UpdateKeeper * pupdatekeeper, ::remoting_rtc::UpdateListener * pupdatelistener, ::subsystem::LogWriter * plogwriter)
   {
