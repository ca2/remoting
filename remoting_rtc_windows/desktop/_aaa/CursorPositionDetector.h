...
namespace remoting_rtc_windows
{
   ...
   public:
      ...
      virtual void initialize_cursor_position_detector(::remoting_rtc::UpdateKeeper * pupdatekeeper, ::remoting_rtc::UpdateListener * pupdatelistener, ::subsystem::LogWriter * plogwriter);
