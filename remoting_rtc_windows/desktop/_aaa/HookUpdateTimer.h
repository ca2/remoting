...
namespace remoting_windows
{
   ...
   public:
      ...
      // @param pupdatelistener - pointer to an ::remoting_rtc::UpdateListener object
      HookUpdateTimer();
      ~HookUpdateTimer() override;


      virtual void initialize_hook_update_timer(::remoting_rtc::UpdateListener *pupdatelistener);
