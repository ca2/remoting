...
namespace remoting_windows
{
   ...
   class CLASS_DECL_REMOTING ::remoting_rtc::UpdateKeeper : public ::subsystem::LockableInterface
   {
   public:
      ::remoting_rtc::UpdateKeeper();
      ::remoting_rtc::UpdateKeeper(const ::i32_rectangle &borderRect);
      ~::remoting_rtc::UpdateKeeper(void);
      ...
      void addChangedRegion(const ::remoting_rtc::Region & regionChanged);
      ...
      void setExcludedRegion(const ::remoting_rtc::Region & regionExcluded);
      ...
      bool checkForUpdates(const ::remoting_rtc::Region & region);
   ...
   private:
      ...
      ::remoting_rtc::Region m_regionExcluded;
