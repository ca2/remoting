...
namespace remoting_rtc_windows
{
   ...
   class CLASS_DECL_REMOTING Desktop : public ::remoting_rtc::UpdateRequestListener
   {
   public:
      virtual ~Desktop() {}
      ...
      virtual void getApplicationRegion(unsigned int procId, ::remoting_rtc::Region & region) = 0;
