...
namespace remoting_rtc_windows
{
   ...
   bool GrabOptimizator::grab(const Region & regionGrab, ::remoting_rtc::ScreenDriver *grabber)
   {
   ...
   bool GrabOptimizator::getOptimizationAvailable(::remoting_rtc::ScreenDriver *grabber)
   {
   ...
   void GrabOptimizator::refreshStatistic(::remoting_rtc::ScreenDriver *grabber)
   {
   ...
   __int64 GrabOptimizator::grabWhole(::remoting_rtc::ScreenDriver *grabber)
   {
   ...
   __int64 GrabOptimizator::grabOneRect(const ::i32_rectangle & rectangle, ::remoting_rtc::ScreenDriver *grabber)
   {
   ...
   __int64 GrabOptimizator::grabFragments(const ::int_rectangle_array_base & rectanglea, ::remoting_rtc::ScreenDriver *grabber)
   {
      // FIXME: WARNING!!! The microsoft API usage!!!
      LARGE_INTEGER timeBegin, timeEnd;
      bool timerResult1 = QueryPerformanceCounter(&timeBegin) != 0;
