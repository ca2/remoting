...
namespace remoting_rtc_windows
{
   ...
   public:
      ...
      virtual void initialize_update_detector(::remoting_rtc::UpdateKeeper * pupdatekeeper, ::remoting_rtc::UpdateListener * pupdatelistener);


      void setUpdateKeeper(::remoting_rtc::UpdateKeeper *pupdatekeeper) { m_pupdatekeeper = pupdatekeeper; }
      ::remoting_rtc::UpdateKeeper *getUpdateKeeper() const { return m_pupdatekeeper; }
