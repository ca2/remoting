...
namespace remoting_windows
{
   ...
   // CursorPositionDetector::CursorPositionDetector(::remoting_rtc::UpdateKeeper * pupdatekeeper, ::remoting_rtc::UpdateListener * pupdatelistener,
   ...
   void CursorPositionDetector::initialize_cursor_position_detector(::remoting_rtc::UpdateKeeper * pupdatekeeper, ::remoting_rtc::UpdateListener * pupdatelistener,
                                                  ::subsystem::LogWriter * plogwriter)
   {
