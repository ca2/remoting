...
namespace remoting_windows
{
   ...
   void ::remoting_rtc::UpdateKeeper::addChangedRegion(const Region & regionChanged)
   {
   ...
   void ::remoting_rtc::UpdateKeeper::addChangedRect(const ::i32_rectangle &rectangleChanged)
   {
      Region region(rectangleChanged);
      addChangedRegion(region);
   }

   void ::remoting_rtc::UpdateKeeper::addCopyRect(const ::i32_rectangle &rectangleCopy, const ::i32_point &pointSource)
   {
      critical_section_lock al(&m_criticalsectionUpdateContainer);
   ...
   void ::remoting_rtc::UpdateKeeper::setBorderRect(const ::i32_rectangle &borderRect)
   {
      critical_section_lock al(&m_criticalsectionUpdateContainer);
      m_rectangleBorder = borderRect;
   }

   void ::remoting_rtc::UpdateKeeper::setScreenSizeChanged()
   {
      critical_section_lock al(&m_criticalsectionUpdateContainer);
      m_updatecontainer.m_bScreenSizeChanged = true;
   }

   void ::remoting_rtc::UpdateKeeper::setCursorPosChanged()
   {
      critical_section_lock al(&m_criticalsectionUpdateContainer);
      m_updatecontainer.m_bCursorPosChanged = true;
   }

   void ::remoting_rtc::UpdateKeeper::setCursorPos(const ::i32_point &curPos)
   {
      critical_section_lock al(&m_criticalsectionUpdateContainer);
      m_updatecontainer.m_bCursorPosChanged = true;
   ...
   void ::remoting_rtc::UpdateKeeper::setCursorShapeChanged()
   {
      critical_section_lock al(&m_criticalsectionUpdateContainer);
      m_updatecontainer.m_bCursorShapeChanged = true;
   }

   void ::remoting_rtc::UpdateKeeper::addUpdateContainer(const UpdateContainer & updatecontainer)
   {
      critical_section_lock al(&m_criticalsectionUpdateContainer);
   ...
   void ::remoting_rtc::UpdateKeeper::getUpdateContainer(UpdateContainer & updatecontainer)
   {
      critical_section_lock al(&m_criticalsectionUpdateContainer);
      updatecontainer = m_updatecontainer;
   }

   bool ::remoting_rtc::UpdateKeeper::checkForUpdates(const Region & region)
   {
   ...
   void ::remoting_rtc::UpdateKeeper::extract(UpdateContainer & updatecontainer)
   {
      {
         critical_section_lock al(&m_criticalsectionUpdateContainer);
   ...
   void ::remoting_rtc::UpdateKeeper::setExcludedRegion(const Region & regionExcluded)
   {
      critical_section_lock al(&m_criticalsectionExclRegLoc);
   ...
   void ::remoting_rtc::UpdateKeeper::clearExcludedRegion()
   {
      critical_section_lock al(&m_criticalsectionExclRegLoc);
