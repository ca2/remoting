...
namespace remoting_rtc_windows
{
   ...
   // Win32ScreenDriver::Win32ScreenDriver(::remoting_rtc::UpdateKeeper * pupdatekeeper, ::remoting_rtc::UpdateListener * pupdatelistener,
   ...
   void Win32ScreenDriver::initialize_screen_driver(::remoting_rtc_node::Configurator * pconfigurator, ::remoting_rtc::UpdateKeeper * pupdatekeeper, ::remoting_rtc::UpdateListener * pupdatelistener,
                                        ::innate_subsystem::Framebuffer *pframebuffer, lockable_critical_section *pcriticalsectionFramebuffer,
                                        ::subsystem::LogWriter * plogwriter) //:
