...
#include "remoting/remoting_rtc/desktop_ipc/UpdateHandlerClient.h"
//#include "windows/WindowsInputBlocker.h"
#include "remoting/remoting_rtc/desktop_ipc/UserInputClient.h"
#include "remoting/remoting_rtc/desktop/SasUserInput.h"
...
namespace remoting_windows
{
   ...
   DesktopClientImpl::~DesktopClientImpl()
   {
      ...
      void DesktopClientImpl::initialize_desktop(
         ...
         ClipboardListener *pclipboardlistenerExternal,
                                        ...
                                        ::remoting_rtc::AbnormDeskTermListener *pdesktermlistenerExternal, ::subsystem::LogWriter * plogwriter) //:
      ...
      //  m_puserinput(0), m_pdesktopconfigclient(0), m_pgatekicker(0), m_plogwriter(plogwriter)
   {
      ...
      //::remoting_rtc::DesktopBaseImpl::initialize_desktop(pconfigurator, pclipboardlistenerExternal, pupdatesendinglistenerExternal, pdesktermlistenerExternal, plogwriter);
      ...
      try
      {
         ...
         m_plogwriter->debug("DesktopClientImpl: Initializing UpdateHandlerClient...");
         m_pupdatehandler = allocateø ::remoting_rtc::UpdateHandlerClient(m_pconfigurator, m_pgateClientToServer, m_pdesktopsrvdispatcher, this, m_plogwriter);

         m_plogwriter->debug("DesktopClientImpl: Initializing UserInputClient...");
         //UserInputClient *userInputClient = new UserInputClient(m_pgateClientToServer, m_pdesktopsrvdispatcher, this);
         auto puserinputclient =allocateø ::remoting_rtc::UserInputClient();
   ...
   {
      ::remoting_rtc::BlockingGate pblockinggate(newChannelTo);
      if (m_pdesktopconfigclient)
      {
