...
namespace remoting_windows
{
   ...
   public:
      ...
      void initialize_wallpaper_util(::remoting_rtc_node::Configurator * pconfigurator, ::subsystem::LogWriter * plogwriter) override;

      void updateWallpaper() override;

   //protected:
      void onConfigReload(::remoting_rtc_node::ServerConfig *serverConfig) override;
