...
namespace remoting_windows
{
   ...
   const ::remoting_rtc::CursorShape *Win8CursorShape::getCursorShape() const
   {
      if (getIsVisible())
      {
   ...
   ::remoting_rtc::CursorShape *Win8CursorShape::getCursorShapeForWriting() { return &m_cursorshape; }
