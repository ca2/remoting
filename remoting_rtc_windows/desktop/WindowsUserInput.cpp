...
//         rectangle.fromWindowsRect(&rectangle);
   ...
   void WindowsUserInput::getApplicationRegion(const ::process_identifier & processidentifier, ::remoting_rtc::Region & region)
   {
      region.clear();
      ...
      while (operatingsystemwindowForeground.is_set())
      {
         ...
         if (style & WS_VISIBLE)
         {
            ...
            {
               region.subtract(::remoting_rtc::Region(rectangle));
            }
         }
