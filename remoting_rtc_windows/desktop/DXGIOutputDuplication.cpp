...
namespace remoting_rtc_windows
{
   ...
   void DXGIOutputDuplication::getFrameCursorShape(::remoting_rtc::CursorShape *cursorShape, ::u32 pointerShapeBufferSize,
                                                      ::subsystem::LogWriter * plogwriter)
   {
      ...
      ::remoting_rtc::CursorShape newCursorShape;
...
void onFrame(Direct3D11CaptureFramePool const &pool)
{
   ...
   ::i32 err = avcodec_send_frame(m_codecCtx, avFrame);
