...
#include "remoting/remoting_rtc/desktop/InputBlocker.h"
...

{
   ...
   void DesktopWinImpl::initialize_desktop(
      ::remoting_rtc_node::Configurator * pconfigurator, ClipboardListener *pclipboardlistenerExternal, ::remoting_rtc::UpdateSendingListener *pupdatesendinglistenerExternal,
       ...
       // m_plogwriter = plogwriter;, m_pscreendriverfactory(m_pconfigurator->getServerConfig())
   {
      ...
      m_pscreendriverfactory->initialize_screen_driver_factory(m_pconfigurator->getServerConfig());
          ...
          try
          {
             m_pupdatehandler = new ::remoting_rtc::UpdateHandlerImpl(m_pconfigurator, this, m_pscreendriverfactory, m_plogwriter);
             bool ctrlAltDelEnabled = false;
