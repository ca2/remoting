...
namespace remoting_client
{
   ...
   public:
      ...
      // a ::pair of abstract "gates" (::remoting_rtc::RfbInputGate and ::remoting_rtc::RfbOutputGate).
      //
      RemoteViewerCore(::remoting_rtc::RfbInputGate *input, ::remoting_rtc::RfbOutputGate *output,
      ...
      // ::remoting_rtc::RfbOutputGate object. Beware of sending data from callbacks, as that can
      // block the input thread for a long time.
      //

      //
      // This version of start() takes any type of connection that can be
      // specified via a ::pair of abstract "gates" (::remoting_rtc::RfbInputGate and ::remoting_rtc::RfbOutputGate).
      //
      void start(::remoting_rtc::RfbInputGate *input, ::remoting_rtc::RfbOutputGate *output,
                 CoreEventsAdapter *adapter,
                 bool sharedFlag = true);
      ...
      ::remoting_rtc::RfbInputGate *m_input;
