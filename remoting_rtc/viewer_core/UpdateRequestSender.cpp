...
//   }
   ...
   void UpdateRequestSender::setOutput(::remoting_rtc::RfbOutputGate* output)
   {
      {
   ...
   {
      ::remoting_rtc::RfbOutputGate* output = getOutput();
   ...
   ::remoting_rtc::RfbOutputGate* UpdateRequestSender::getOutput()
   {
      critical_section_lock al(&m_outputLock);
