...
namespace remoting_client
{
   ...
   namespace file_transfer
   {
      ...
      void FileTransferCapability::setOutput(::remoting_rtc::RfbOutputGate *output)
      {
         m_ftRequestSender.setOutput(output);
      }

      ::remoting_rtc::file_transfer::FileTransferCore *FileTransferCapability::getCore()
      {
         return &m_ftCore;
      }

      void FileTransferCapability::setInterface(::remoting_rtc::file_transfer::FileTransferInterface *ftInterface)
      {
