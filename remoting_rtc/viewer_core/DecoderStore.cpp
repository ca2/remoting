...
namespace remoting_client
{
   ...
   : m_plogwriter(plogwriter),
     m_preferredEncoding(::remoting_rtc::EncodingDefs::TIGHT),
   ...
   ::array_base<::i32> DecoderStore::getDecoderIds()
   {
      ...
      for (auto i = m_decoders.begin();
         ...
         if (i->m_element1 != m_preferredEncoding) {
            ...
            if (i->m_element1 != ::remoting_rtc::EncodingDefs::COPYRECT || m_allowCopyRect)
      ...
      if (sortedDecoders.empty())
         sortedDecoders.add(::remoting_rtc::EncodingDefs::RAW);
