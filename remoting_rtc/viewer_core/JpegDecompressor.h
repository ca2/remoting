...
// For using libjpeg for encoding go to Property Pages of remoting_rtc_node -> Linker -> Input -> Additional Dependencies
...
// For Visual Studio 2008 add libjpeg project to the dependencies of remoting_rtc_node.
