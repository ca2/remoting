...
namespace remoting_client
{
   ...
   : AuthHandler(::remoting_rtc::AuthDefs::VNC)
   {
   }
   ...
   {
      pcapabilitiesmanager->addAuthCapability(this, ::remoting_rtc::AuthDefs::VNC, ::remoting_rtc::VendorDefs::STANDARD, ::remoting_rtc::AuthDefs::SIG_VNC);
   }
} // namespace remoting_client