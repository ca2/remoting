...
namespace remoting_client
{
   ...
   {
      m_encoding = ::remoting_rtc::EncodingDefs::RAW;
   }
   ...
   void RawDecoder::process(::remoting_rtc::RfbInputGate *input,
   ...
   void RawDecoder::decode(::remoting_rtc::RfbInputGate *pinput,
                        ::innate_subsystem::Framebuffer *pframebuffer,
                        const ::i32_rectangle &  rectangle)
   {
