...
namespace remoting_rfb_client
{
   ...
   void RfbCutTextEventClientMessage::send(::remoting_rfb::RfbOutputGate *prfboutputgate)
   {
      ::string cutTextAnsi;
      ...
      prfboutputgate->writeUInt8(::remoting_rfb::ClientMsgDefs::CLIENT_CUT_TEXT);
   ...
   void RfbCutTextEventClientMessage::sendUtf8(::remoting_rfb::RfbOutputGate *prfboutputgate)
   {
      ::string cutTextUtf;
      ...
      critical_section_lock al(prfboutputgate);
      prfboutputgate->writeUInt32(::remoting_rfb::ClientMsgDefs::CLIENT_CUT_TEXT_UTF8);
      prfboutputgate->writeUInt32(length);
