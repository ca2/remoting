...
#include "remoting/remoting_rtc/desktop/Desktop.h"
...
namespace remoting
{
   ...
   public:
      ...
      void initDesktopInterface(::remoting_rtc::Desktop *desktop);
      ...
      void getApplicationRegion(::remoting_rtc::Region & region);
