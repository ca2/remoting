...
#include "remoting/remoting_rtc/rfb_sconn/ClipboardExchange.h"
...
void UpdateSender::destroy()
{
   ...
   delete m_pupdatekeeper;
    ...
    void  UpdateSender::initialize_update_sender(RfbCodeRegistrator *m_prfbcoderegistrator, UpdateRequestListener *updReqListener,
                              SenderControlInformationInterface *senderControlInformation, ::remoting_rtc::RfbOutputGate *prfboutputgate,
                              ::i32 id, Desktop *desktop, ::subsystem::LogWriter * plogwriter) //:
       // , , ,
       // ,
   ...
   void UpdateSender::onRequest(::u32 reqCode, ::remoting_rtc::RfbInputGate *input)
   {
   ...
   void UpdateSender::readUpdateRequest(::remoting_rtc::RfbInputGate *io)
   {
   ...
   void UpdateSender::readSetPixelFormat(::remoting_rtc::RfbInputGate *io)
   {
   ...
   void UpdateSender::readSetEncodings(::remoting_rtc::RfbInputGate *io)
   {
   ...
   void UpdateSender::readVideoFreeze(::remoting_rtc::RfbInputGate *io) { setVideoFrozen(io->readUInt8() != 0); }
