...
namespace remoting_rtc_node
{
   ...
   {
   public:
      ConfigDialog(Configurator * pconfigurator, ::remoting_rtc_node::ControlCommand *reloadConfigCommand);
      ...
      void setConfigReloadCommand(::remoting_rtc_node::ControlCommand *command);
   ...
   protected:
      ...
      ::remoting_rtc_node::ServerConfigDialog m_serverConfigDialog;
      ...
      ::pointer < ::remoting_rtc_node::ControlCommand > m_pcontrolcommandReloadConfig;
