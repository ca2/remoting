...
{
   ConfigDialog::ConfigDialog(Configurator * pconfigurator, ::remoting_rtc_node::ControlCommand *reloadConfigCommand)
   :
   ...
   void ConfigDialog::setConfigReloadCommand(::remoting_rtc_node::ControlCommand *command)
   {
