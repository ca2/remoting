...
#include "remoting/remoting_rtc/node_user_config/ChangePasswordDialog.h"
...
namespace remoting_rtc_node
{
   ...
   bool AdministrationConfigDialog::validateInput()
   {
      ...
      // FIXME: Code duplicate (see ::remoting_rtc_node::ServerConfigDialog class).
   ...
   void AdministrationConfigDialog::updateUI()
   {
      ...
      switch (m_pserverconfig->getDisconnectAction()) {
         case ::remoting_rtc_node::ServerConfig::DA_DO_NOTHING:
   ...
   void AdministrationConfigDialog::apply()
   {
      ...
      if (m_disconnectAction[0].isChecked()) {
         m_pserverconfig->setDisconnectAction(::remoting_rtc_node::ServerConfig::DA_DO_NOTHING);
      } else if (m_disconnectAction[1].isChecked()) {
         m_pserverconfig->setDisconnectAction(::remoting_rtc_node::ServerConfig::DA_LOCK_WORKSTATION);
      } else if (m_disconnectAction[2].isChecked()) {
         m_pserverconfig->setDisconnectAction(::remoting_rtc_node::ServerConfig::DA_LOGOUT_WORKSTATION);
      }
