...
namespace remoting
{
   ...
   public:
      ...
      virtual void initialize_desktop_server_proto(::remoting_rtc_node::Configurator * pconfigurator, BlockingGate *pblockinggate);
      ...
      virtual void sendRegion(const ::remoting_rtc::Region & region, BlockingGate *pblockinggate);
      virtual void readRegion(::remoting_rtc::Region & region, BlockingGate *pblockinggate);
