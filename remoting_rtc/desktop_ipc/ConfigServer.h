...
#include "remoting/remoting_rtc/desktop_ipc/ClientListener.h"
...
namespace remoting
{
   ...
   public:
      ...
      virtual void initialize_config_server(::remoting_rtc_node::Configurator * pconfigurator, DesktopSrvDispatcher * pdispatcher, ::subsystem::LogWriter * plogwriter);
