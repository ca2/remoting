...
void UserInputClient::initialize_user_input_client(::remoting_rtc_node::Configurator * pconfigurator, BlockingGate *pblockinggate, DesktopSrvDispatcher * pdispatcher, ::subsystem::ClipboardListener *pclipboardlistener)
//: DesktopServerProto(pblockinggate),
//  m_clipboardListener(pclipboardlistener),
//  m_sendMouseFlags(0)
{
