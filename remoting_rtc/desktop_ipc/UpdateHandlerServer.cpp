...
namespace remoting
{
   ...
   // UpdateHandlerServer::UpdateHandlerServer(::remoting_rtc_node::Configurator *pconfigurator, BlockingGate *pblockinggate, DesktopSrvDispatcher * pdispatcher,
   ...
   void UpdateHandlerServer::initialize_update_handler_server(::remoting_rtc_node::Configurator *pconfigurator, BlockingGate *pblockinggate, DesktopSrvDispatcher * pdispatcher,
              // AnEventListener *extTerminationListener,
