...
namespace remoting
{
   ...
   void ConfigServer::initialize_config_server(::remoting_rtc_node::Configurator * pconfigurator, DesktopSrvDispatcher *pdispatcher, ::subsystem::LogWriter * plogwriter)
   {
