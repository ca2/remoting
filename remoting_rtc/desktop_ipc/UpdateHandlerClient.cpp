...
namespace remoting
{
   ...
   UpdateHandlerClient::UpdateHandlerClient(::remoting_rtc_node::Configurator * pconfigurator, BlockingGate *pblockinggate, DesktopSrvDispatcher * pdispatcher,
                     UpdateListener *pupdatelistenerExternal, ::subsystem::LogWriter * plogwriter)
   {
   ...
   UpdateHandlerClient::~UpdateHandlerClient() {}
    ...
    void UpdateHandlerClient::initialize_update_handler_client(::remoting_rtc_node::Configurator * pconfigurator, BlockingGate *pblockinggate, DesktopSrvDispatcher * pdispatcher,
                    UpdateListener *pupdatelistenerExternal, ::subsystem::LogWriter * plogwriter)
   {
