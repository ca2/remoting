...
namespace remoting
{
   ...
   public:
      ...
      virtual void initialize_user_input_client(::remoting_rtc_node::Configurator * pconfigurator, BlockingGate *pblockinggate, DesktopSrvDispatcher * pdispatcher, ::subsystem::ClipboardListener *pclipboardlistener);
