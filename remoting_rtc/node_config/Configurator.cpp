...
//#include "remoting/remoting_rtc/node_user_config/TvnLogFilename.h"
#include "remoting/remoting_rtc/config/RegistrySettingsManager.h"
...
namespace remoting_rtc_node
{
   ...
   // }
   //
   // void Configurator::setInstance(::remoting_rtc_node::Configurator *conf) { s_instance = conf; }
   ...
   bool Configurator::load(bool forService)
   {
      ...
      ::remoting_rtc::RegistrySettingsManager sm(pregistrykey, "Software/remoting/server");
   ...
   bool Configurator::save(bool forService)
   {
      ...
      //   sa = m_regSA->getServiceSA();
      // }
      //::remoting_rtc::RegistrySettingsManager sm(rootKey, RegistryPaths::SERVER_PATH, sa);
       ::remoting_rtc::RegistrySettingsManager sm(pregistrykey,"Software/remoting/server");
   ...
   bool Configurator::save(::remoting_rtc::SettingsManager *sm)
   {
   ...
   bool Configurator::load(::remoting_rtc::SettingsManager *sm)
   {
   ...
   bool Configurator::savePortMappingContainer(::remoting_rtc::SettingsManager *sm)
   {
      bool saveResult = true;
   ...
   bool Configurator::loadPortMappingContainer(::remoting_rtc::SettingsManager *sm, PortMappingContainer *portMapping)
   {
      bool wasError = false;
   ...
   bool Configurator::saveQueryConfig(::remoting_rtc::SettingsManager *sm)
   {
      bool saveResult = true;
   ...
   bool Configurator::loadQueryConfig(::remoting_rtc::SettingsManager *sm, ::remoting_rtc_node::ServerConfig * pserverconfig)
   {
      bool loadResult = true;
      ::u32 uintValue;
      bool boolValue;
   ...
   bool Configurator::saveInputHandlingConfig(::remoting_rtc::SettingsManager *sm)
   {
      bool saveResult = true;
   ...
   bool Configurator::loadInputHandlingConfig(::remoting_rtc::SettingsManager *sm, ::remoting_rtc_node::ServerConfig * pserverconfig)
   {
      bool loadResult = true;
   ...
   bool Configurator::saveVideoRegionConfig(::remoting_rtc::SettingsManager *sm)
   {
      bool saveResult = true;
      ...
      {
         ::string s;
         ::remoting_rtc::RectSerializer::toString(rectangleaVideo->at(i), s);
         buffer += s;
         if (i != size - 1)
         {
            buffer += "\n";
   ...
   bool Configurator::loadVideoRegionConfig(::remoting_rtc::SettingsManager *sm, ::remoting_rtc_node::ServerConfig * pserverconfig)
   {
      bool loadResult = true;
      ...
      if (chunks.has_element())
      {
         ...
         for (size_t i = 0; i < count; i++)
         {
            if (!chunks[i].is_empty())
            {
               rectangleaVideo->add(::remoting_rtc::RectSerializer::toRect(chunks[i]));
            }
         }
      }
      return loadResult;
   ...
   bool Configurator::saveIpAccessControlContainer(::remoting_rtc::SettingsManager *storage)
   {
      AutoLock l(m_pserverconfig.m_p);
   ...
   bool Configurator::loadIpAccessControlContainer(::remoting_rtc::SettingsManager *sm, IpAccessControl *rules)
   {
      bool wasError = false;
      rules->clear();
   ...
   bool Configurator::saveServerConfig(::remoting_rtc::SettingsManager *sm)
   {
      bool saveResult = true;
   ...
   bool Configurator::loadServerConfig(::remoting_rtc::SettingsManager *sm, ::remoting_rtc_node::ServerConfig * pserverconfig)
   {
      bool loadResult = true;
      ...
      {
         m_isConfigLoadedPartly = true;
         m_pserverconfig->setDisconnectAction((::remoting_rtc_node::ServerConfig::DisconnectAction)uintVal);
      }
