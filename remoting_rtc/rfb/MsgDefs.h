...
{
   class CLASS_DECL_REMOTING_RFB ClientMsgDefs
   {
   public:
   ...
   class CLASS_DECL_REMOTING_RFB ServerMsgDefs
   {
   public:
   ...
   class CLASS_DECL_REMOTING_RFB Utf8CutTextDefs
   {
   public:
   ...
   class CLASS_DECL_REMOTING_RFB EchoExtensionDefs
   {
   public:
