...
namespace remoting_rtc_node
{
   ...
   ::string_literal LogNames::SERVER_LOG_FILE_STUB_NAME = "remoting_rtc_node";
   ...
   ::string_literal LogNames::WIN_EVENT_PROVIDER_NAME = "remoting_rtc_node";
   ...
   ::string_literal ServiceNames::SERVICE_NAME = "remoting_rtc_node";
