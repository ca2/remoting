...
#include "remoting/remoting_rtc/rfb_sconn/RfbDispatcherListener.h"
...
namespace remoting
{
   ...
   namespace file_transfer
   {
      ...
      public:
         ...
         ::pointer < ::remoting_rtc::RfbInputGate > m_prfbinputgate;
          ...
          */
         FileTransferRequestHandler(::remoting_rtc_node::Configurator * pconfigurator,
          ...
          */
         virtual void onRequest(::u32 reqCode, ::remoting_rtc::RfbInputGate *backGate);
