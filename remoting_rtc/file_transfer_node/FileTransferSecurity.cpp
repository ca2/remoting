...
namespace remoting
{
   ...
   {
//      FileTransferSecurity::FileTransferSecurity(::remoting_rtc_node::Configurator * pconfigurator, Desktop *desktop, ::subsystem::LogWriter *plogwriter)
//      :
...
//      }
   ...
   void FileTransferSecurity::initialize_file_transfer_security(::remoting_rtc_node::Configurator * pconfigurator, Desktop *desktop, ::subsystem::LogWriter *plogwriter)
   {
      m_plogwriter = plogwriter;
      m_pconfigurator = pconfigurator;
      m_pdesktop = desktop;
