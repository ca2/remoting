...
namespace remoting
{
   ...
   void WallpaperUtil::initialize_wallpaper_util(::remoting_rtc_node::Configurator * pconfigurator, ::subsystem::LogWriter *plogwriter)
   {
   ...
   void WallpaperUtil::onConfigReload(::remoting_rtc_node::ServerConfig *serverConfig) { updateWallpaper(); }
