...
namespace remoting
{
   ...
   public:
      ...
      virtual void initialize_screen_driver(::remoting_rtc_node::Configurator * pconfigurator, UpdateKeeper * pupdatekeeper, UpdateListener * pupdatelistener,
      ...
      virtual const ::remoting_rtc::CursorShape *getCursorShape() = 0;
      ...
      virtual ::remoting_rtc::Region getVideoRegion() = 0;
   };
