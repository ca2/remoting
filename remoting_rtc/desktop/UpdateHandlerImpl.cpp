...
namespace remoting
{
   ...
   UpdateHandlerImpl::UpdateHandlerImpl(::remoting_rtc_node::Configurator * pconfigurator, UpdateListener *pupdatelistenerExternal, ScreenDriverFactory *pscreendriverfactory,
