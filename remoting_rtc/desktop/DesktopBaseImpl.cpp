...

{
   ...
   void DesktopBaseImpl::initialize_desktop_base_impl(::remoting_rtc_node::Configurator * pconfigurator, ::subsystem::ClipboardListener *pclipboardlistenerExternal, UpdateSendingListener *pupdatesendinglistenerExternal,
                AbnormDeskTermListener *pdesktermlistenerExternal, ::subsystem::LogWriter * plogwriter)
   {
   ...
   void DesktopBaseImpl::onConfigReload(::remoting_rtc_node::ServerConfig *serverConfig) { applyNewConfiguration(); }
