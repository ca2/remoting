...

{
   ...
   public:
      ...
      virtual void initialize_screen_driver_factory(::remoting_rtc_node::ServerConfig *pserverconfig);

      virtual ::pointer < ::remoting_rtc::ScreenDriver > createScreenDriver(
