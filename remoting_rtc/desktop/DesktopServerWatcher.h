...
namespace remoting
{
   ...
   public:
      ...
      virtual void initialize_desktop_server_watcher(::remoting_rtc_node::Configurator * pconfigurator, ReconnectionListener *preconnectionlistener, ::subsystem::LogWriter * plogwriter);
