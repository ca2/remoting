...
//#endif
      ...
      //m_spinstall = øallocate class install (this);
   ...
   void application::defer_show_debug_box()
   {
      ...
      if (directory_system()->config() / "spa/beg_debug_box.txt")
      {
         ...
         auto pmessagebox = message_box(str + " - zzzAPPzzz install", m_strAppName, ::user::e_message_box_icon_information);
...
//      }
   ...
   void application::init_instance()
   {
      ...
      factory()->add_factory_item < ::install::incoming_socket >();
      factory()->add_factory_item < ::install::socket >();
...
//      }
   ...
   void application::on_request(::request * prequest)
   {
      ...
      if (!m_pincomingsocketthread)
      {
         ...
         øconstruct_new(m_pincomingsocketthread);
   ...
   void application::add_command_line(const ::scoped_string & scopedstr)
   {

      {
         ...
         //auto pmutexCommnadFile = øallocate ::pointer < ::mutex > (this, false, "Local\\ca2_spa_command:" + node()->process_platform_name());
   ...
   string application::pick_command_line()
   {
      ...
      //auto pmutexCommandFile = øallocate ::pointer < ::mutex > (this, false, "Local\\ca2_spa_command:" + node()->process_platform_name());
...
//      psystem->m_bMatterFromHttpCache = true;
   ...
   bool application::is_user_service_running()
   {
      ...
      //auto pmutex = øallocate ::pointer < ::mutex > (this, false, "Local\\ca2_application_local_mutex:application-aura/user_service");
