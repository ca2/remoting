...
#include "remoting/remoting_rfb/file_transfer_common/FolderListener.h"
...
// #include "network/::remoting_rfb::RfbInputGate.h"
...
namespace remoting_rfb
{
   ...
   namespace file_transfer
   {
      ...
      FileTransferRequestHandler::FileTransferRequestHandler(::remoting_rfb_node::Configurator * pconfigurator,
      ...
      void FileTransferRequestHandler::onRequest(::u32 reqCode, ::remoting_rfb::RfbInputGate *backGate)
      {
      ...
      void FileTransferRequestHandler::fileListRequested()
      {
         ...
         //const ::remoting_rfb::file_transfer::FileInfo *files = NULL;

         //
         // Get file list from specified folder
         //

         ::remoting_rfb::file_transfer::FolderListener folderListener(this, strFullPathName);
