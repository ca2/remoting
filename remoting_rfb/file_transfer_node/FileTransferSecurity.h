...
namespace remoting_rfb
{
   ...
   {
      class CLASS_DECL_REMOTING_RFB FileTransferSecurity :
   ...
   virtual public ::particle
      ...
      public:
         ...
         ::remoting_rfb::Desktop *m_pdesktop;

         ::pointer < ::subsystem::LogWriter > m_plogwriter;
         ::pointer < ::remoting_rfb_node::Configurator > m_pconfigurator;


         //FileTransferSecurity(::remoting_rfb_node::Configurator * pconfigurator, ::remoting_rfb::Desktop *desktop, ::subsystem::LogWriter *log);
         
         FileTransferSecurity();
         ~FileTransferSecurity() override;

         virtual void initialize_file_transfer_security(::remoting_rfb_node::Configurator * pconfigurator, ::remoting_rfb::Desktop *desktop, ::subsystem::LogWriter *log);
