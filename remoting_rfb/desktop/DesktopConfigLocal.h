...
namespace remoting_rfb
{
   ...
   class CLASS_DECL_REMOTING_RFB DesktopConfigLocal :
   ...
   public:
      ...
      void initialize_desktop_config_local(::remoting_rfb_node::Configurator * pconfigurator, ::subsystem::LogWriter * plogwriter);
