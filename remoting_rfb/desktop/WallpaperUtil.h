...
namespace remoting_rfb
{
   ...
   class CLASS_DECL_REMOTING_RFB WallpaperUtil :
   ...
   public:
      ...
      virtual void initialize_wallpaper_util(::remoting_rfb_node::Configurator * pconfigurator, ::subsystem::LogWriter * plogwriter);
