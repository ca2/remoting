...
#include "remoting/remoting_rfb/rfb_sconn/EncodeOptions.h"
#include "remoting/remoting_rfb/rfb/CursorShape.h"
#include "remoting/remoting_rfb/desktop/UpdateContainer.h"
...
namespace remoting_rfb
{
   ...
   class CLASS_DECL_REMOTING_RFB  CursorUpdates :
   ...
   public:
      ...
      void update(const EncodeOptions *encodeOptions, UpdateContainer & updatecontainer, bool fullRegReq,
                  const ::i32_rectangle &rectangleViewport, bool shareOnlyApp, const ::remoting_rfb::Region & regionShareApp,
                  ::innate_subsystem::Framebuffer *pframebuffer, ::remoting_rfb::CursorShape *cursorShape);
      ...
      void updateCursorShape(const ::remoting_rfb::CursorShape *curShape);

   //private:
      // Clones the internal cursor shape to curShape.
      void extractCursorShape(::remoting_rfb::CursorShape *curShape);
