...
#include "remoting/remoting_rfb/desktop/UpdateHandler.h"
...
namespace remoting_rfb
{
   ...
   class CLASS_DECL_REMOTING_RFB  UpdateHandlerClient :
   ...
   public:
      ...
      UpdateHandlerClient();
      UpdateHandlerClient(::remoting_rfb_node::Configurator * pconfigurator, BlockingGate *pblockinggate, DesktopSrvDispatcher * pdispatcher,
                           UpdateListener *pupdatelistenerExternal, ::subsystem::LogWriter * plogwriter);
      ~UpdateHandlerClient() override;

      virtual void initialize_update_handler_client(::remoting_rfb_node::Configurator * pconfigurator, BlockingGate *pblockinggate, DesktopSrvDispatcher * pdispatcher,
                          UpdateListener *pupdatelistenerExternal, ::subsystem::LogWriter * plogwriter);
