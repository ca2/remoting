...
namespace remoting_rfb_client
{
    ...
    //
    class CLASS_DECL_REMOTING_RFB AuthException : public ::subsystem::Exception
    {
    public:
    ...
    class CLASS_DECL_REMOTING_RFB AuthUnknownException : public AuthException
    {
    public:
    ...
    //
    class CLASS_DECL_REMOTING_RFB AuthCanceledException : public AuthException
    {
    public:
    ...
    class CLASS_DECL_REMOTING_RFB AuthHandler :
