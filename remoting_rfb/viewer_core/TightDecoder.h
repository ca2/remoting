...
{
   class CLASS_DECL_REMOTING_RFB TightDecoder : public DecoderOfRectangle
   {
   public:
   ...
   private:
      ...
      ::u32 readTightPixel(::remoting_rfb::RfbInputGate *input, ::i32 bytesPerCPixel);
      ::i32 readCompactSize(::remoting_rfb::RfbInputGate *input);
