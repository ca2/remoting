...
namespace remoting_rfb_client
{
   ...
   //
   class CLASS_DECL_REMOTING_RFB RemoteViewerCore :
   ...
   public:
      ...
      // a ::pair of abstract "gates" (::remoting_rfb::RfbInputGate and ::remoting_rfb::RfbOutputGate).
      //
      RemoteViewerCore(::remoting_rfb::RfbInputGate *input, ::remoting_rfb::RfbOutputGate *output,
      ...
      // ::remoting_rfb::RfbOutputGate object. Beware of sending data from callbacks, as that can
      // block the input thread for a long time.
      //

      //
      // This version of start() takes any type of connection that can be
      // specified via a ::pair of abstract "gates" (::remoting_rfb::RfbInputGate and ::remoting_rfb::RfbOutputGate).
      //
      void start(::remoting_rfb::RfbInputGate *input, ::remoting_rfb::RfbOutputGate *output,
                 CoreEventsAdapter *adapter,
                 bool sharedFlag = true);
      ...
      void addEncodingCapability(Decoder *decoder,
      ...
      void getEnabledClientMsgCapabilities(::array_base<::u32> *codes) const override;
      void getEnabledServerMsgCapabilities(::array_base<::u32> *codes) const override;
      void getEnabledEncodingCapabilities(::array_base<::u32> *codes) const override;
