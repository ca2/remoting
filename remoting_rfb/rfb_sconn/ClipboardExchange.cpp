...
//   waitThreadToFinish();
   ...
   void ClipboardExchange::onRequest(::u32 reqCode, ::remoting_rfb::RfbInputGate *prfbinputgate)
   {
   ...
   void ClipboardExchange::onRequestWorker(bool utf8flag, ::remoting_rfb::RfbInputGate *prfbinputgate)
   {
