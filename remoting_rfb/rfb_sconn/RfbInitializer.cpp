...
namespace remoting_rfb
{
   ...
   void RfbInitializer::initialize_rfb_initializer(::remoting_rfb_node::Configurator * pconfigurator, Channel * pchannel, ClientAuthListener *pclientauthlistener, RfbClient *prfbclient, bool bAuthAllowed)
   {
   ...
   void RfbInitializer::doVncAuth()
   {
      ...
      if (!hasPrim && !hasRdly) {
         throw ::remoting_rfb_node::AuthException("Server is not configured properly");
      }
      ...
      throw ::remoting_rfb_node::AuthException(errMess);
   }
   ...
   void RfbInitializer::initAuthenticate()
   {
      ...
      } catch (::remoting_rfb_node::AuthException &e) {
   ...
   void RfbInitializer::checkForBan()
   {
      if (m_pclientauthlistener->onCheckForBan(m_prfbclient)) {
         throw ::remoting_rfb_node::AuthException("Your connection has been rejected");
      }
   }
} // namespace remoting_rfb
