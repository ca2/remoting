...
#include "remoting/remoting_rtc/desktop_ipc/UpdateHandlerServer.h"
#include "remoting/remoting_rtc/desktop_ipc/UserInputServer.h"
#include "remoting/remoting_rtc/desktop_ipc/ConfigServer.h"
#include "remoting/remoting_rtc/desktop_ipc/GateKickHandler.h"
...
namespace remoting_node_desktop
{
   ...
   //private:
      ...
      // Servers
     ::pointer < ::remoting_rtc::UpdateHandlerServer >m_pupdatehandlerserver;
     ::pointer < ::remoting_rtc::UserInputServer >m_puserinputserver;
     ::pointer < ::remoting_rtc::ConfigServer >m_pconfigserver;
     ::pointer < ::remoting_rtc::GateKickHandler >m_pgatekickhandler;
