...
namespace remoting_rfb_node_desktop
{
   ...
   ExtraRfbServers::~ExtraRfbServers()
   {
      ...
      void ExtraRfbServers::initialize_extra_rfb_servers(::remoting_rfb_node::Configurator * pconfigurator, ::subsystem::LogWriter *plogwriter)
   {
   ...
   bool ExtraRfbServers::startUp(bool asService, RfbClientManager *mgr)
   {
      ...
      if (newConf.acceptConnections)
      {
         ...
         {
            ::remoting_rfb_node::PortMapping pm = *newConf.extraPorts.at(i);
            ::remoting_rfb_node::PortMappingRect rectangle = pm.getRect();
            ::i32 port = pm.getPort();
   ...
   void ExtraRfbServers::getConfiguration(Conf *out)
   {
      ...
      //          ::remoting_rfb_node::ServerConfig *cfg = ca.getServerConfig();  // get access
