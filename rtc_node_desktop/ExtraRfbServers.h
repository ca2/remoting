...
namespace remoting_rfb_node_desktop
{
   ...
   public:
      struct Conf
      {
         ...
         bool loopbackOnly;
         ::remoting_rfb_node::PortMappingContainer extraPorts;
   ...
   //public:
      ...
      virtual void initialize_extra_rfb_servers(::remoting_rfb_node::Configurator * pconfigurator, ::subsystem::LogWriter * plogwriter);
