...
namespace remoting_node_desktop
{
    ...
    */
   class CLASS_DECL_REMOTING_RTC_NODE_DESKTOP QueryConnectionApplication :
   ...
   public:
      ...
      virtual void initialize_query_connection_application(::remoting_rtc_node::Configurator * pconfigurator, const ::scoped_string &scopedstrCmdLine);
