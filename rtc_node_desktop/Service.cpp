...
namespace remoting_node_desktop
{
   ...
   {
      m_bService = true;
      initialize_service(::remoting_rtc_node::ServiceNames::SERVICE_NAME);
   }
   ...
   void Service::initialize_remoting_node_desktop_service(ServiceEvents * pwinserviceevents,
                                                          ::remoting_rtc_node::NewConnectionEvents *pnewconnectionevents)
   {
   ...
   void Service::install()
   {
      ...
      scManager.installService(::remoting_rtc_node::ServiceNames::SERVICE_NAME,
                               ::remoting_rtc_node::ServiceNames::SERVICE_NAME_TO_DISPLAY,
                               binPath, "");
   }
   ...
   void Service::remove()
   {
      ...
      scManager.removeService(::remoting_rtc_node::ServiceNames::SERVICE_NAME);
   }
   ...
   void Service::start(bool waitCompletion)
   {
      ...
      scManager.startService(::remoting_rtc_node::ServiceNames::SERVICE_NAME, waitCompletion);
   }
   ...
   void Service::stop(bool waitCompletion)
   {
      ...
      scManager.stopService(::remoting_rtc_node::ServiceNames::SERVICE_NAME, waitCompletion);
   }
