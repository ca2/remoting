...
namespace remoting_control_desktop
{
   ...
   void ControlProxy::setServerConfig(::remoting_rtc_node::ServerConfig * pserverconfig)
   {
      critical_section_lock l(m_pcontrolgate);
   ...
   void ControlProxy::getServerConfig(::remoting_rtc_node::ServerConfig * pserverconfig)
   {
      critical_section_lock l(m_pcontrolgate);
