...
namespace remoting_control_desktop
{
   ...
   void ControlMessage::checkRetCode()
   {
      ...
      switch (messageId) {
         case ControlProto::REPLY_ERROR:
         {
            ...
            throw ::remoting_rtc_node::RemoteException(strMessage);
         }
            break;
            ...
            if (m_passwordFile.length() != 0) {
               ...
               switch (retCode) {
                  case ::innate_subsystem::e_control_id_cancel:
                     throw ::remoting_rtc_node::ControlAuthException(MainSubsystem().StringTable().getString(IDS_USER_CANCEL_CONTROL_AUTH), true);
         ...
         default:
            ASSERT(false);
            throw ::remoting_rtc_node::RemoteException("Unknown ret code.");
      }
   }
   ...
   void ControlMessage::authFromRegistry()
   {
      ...
      ::remoting_rtc::RegistrySettingsManager sm(rootKey, ::remoting_rtc_node::RegistryPaths::SERVER_PATH, 0);
