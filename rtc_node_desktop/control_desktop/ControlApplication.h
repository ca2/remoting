...
namespace remoting_control_desktop
{
   ...
   class ControlApplication : public subsystem::OperatingSystemApplication, /** Windows application running on current interactive desktop. */
                              public ::remoting_rtc_node::Notificator, /** Implement interface to show notifications. */
                              public ::subsystem::Thread /** Status check thread. */
   {
   public:


      Implement1Defaultø(subsystem::OperatingSystemApplication)
   ...
   private:
       ...
       * @fixme move in to remoting_rtc_node application as additional application.
       */
