...
namespace remoting_control_desktop
{
   ...
   ControlTrayIcon::ControlTrayIcon(::remoting_rtc_node::Configurator * pconfigurator, ControlProxy *pcontrolproxy,
                                    ::remoting_rtc_node::Notificator *notificator,
...
initialize(::system());
      ...
      m_pcontrolcommandApplyChanges = allocateø ::remoting_rtc_node::ControlCommand(m_pmacrocommandApplyChanges, m_pnotificator);

      // Create config dialog.
      m_pconfigdialog = allocateø ::remoting_rtc_node::ConfigDialog(m_pconfigurator);
...
void ControlTrayIcon::onAction(int action)
{
   ...
   void ControlTrayIcon::onConfigurationMenuItemClick()
   {
      ...
      if (!m_pconfigdialog->isCreated()) {
         ...
         ::remoting_rtc_node::ControlCommand safeCommand(&updateLocalConfigCommand, m_pcontrolapplication);
   ...
   void ControlTrayIcon::onDisconnectAllClientsMenuItemClick()
   {
      ...
      ::remoting_rtc_node::ControlCommand safeCommand(&unsafeCommand, m_pnotificator);
