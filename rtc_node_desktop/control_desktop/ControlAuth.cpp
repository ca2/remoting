...
namespace remoting_control_desktop
{
   ...
   : m_pcontrolgate(pcontrolgate)
   {
      ...
      //truncatedPass.getSubstring(&truncatedPass, 0, ::remoting_rtc_node::ServerConfig::VNC_PASSWORD_SIZE - 1);
      ...
      switch (result) {
         case ControlProto::REPLY_ERROR:
         {
            ...
            throw ::remoting_rtc_node::ControlAuthException(authFailReason);
         }
            break;
