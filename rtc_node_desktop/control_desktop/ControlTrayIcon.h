...
#include "remoting/remoting_rtc/node/Notificator.h"
...
namespace remoting_control_desktop
{
   ...
   public:
       ...
       * @param serverControl proxy to onThreadMain methods in Remoting Node process.
       ...
       */
      ControlTrayIcon(::remoting_rtc_node::Configurator * pconfigurator,
   ...
   protected:
      ...
      ::pointer < ::remoting_rtc_node::Notificator > m_pnotificator;
      ...
      // Interface to onThreadMain some commands on remote Remoting Node.
      ::pointer < ControlProxy > m_pcontrolproxy;

      // Configuration dialog.
      ::pointer < ::remoting_rtc_node::ConfigDialog > m_pconfigdialog;
      // About dialog.
      ...
      ::pointer < ::remoting_rtc_node::ControlCommand  > m_pcontrolcommandApplyChanges;
