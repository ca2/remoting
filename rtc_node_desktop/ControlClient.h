...
#include "remoting/remoting_rtc/node/ControlAuthException.h"
...
namespace remoting_node_desktop
{
    ...
    */
   class CLASS_DECL_REMOTING_RTC_NODE_DESKTOP ControlClient : public ::subsystem::Thread
   {
   public:
       ...
       */
      ControlClient(::remoting_rtc_node::Configurator * pconfigurator, ::remoting_control_desktop::Transport *transport, RfbClientManager *rfbClientManager, ControlAppAuthenticator *authenticator,
