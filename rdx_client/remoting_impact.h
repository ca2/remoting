...
namespace remoting_client
{
   ...
   public:
      ...
      void newConnection(const ::scoped_string & hostName, ::remoting_rtc::ConnectionConfig * pconnectionconfig);
      void newConnection(ConnectionData * pconnectiondata, ::remoting_rtc::ConnectionConfig * pconnectionconfig);
...
void defer_check_dead_instance();
      ...
      void runInstance(ConnectionData * pconnectiondata, ::remoting_rtc::ConnectionConfig * pconnectionconfig);
      void runInstance(const ::scoped_string & hostName, ::remoting_rtc::ConnectionConfig * pconnectionconfig);
