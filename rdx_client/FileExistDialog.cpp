...
namespace remoting_client
{
    ...
    void FileExistDialog::setFilesInfo(::remoting_rtc::file_transfer::FileInfo *existingFileInfo, ::remoting_rtc::file_transfer::FileInfo *newFileInfo,
    ...
    void FileExistDialog::updateGui(::remoting_rtc::file_transfer::FileInfo *fileInfo, ::innate_subsystem::Control *sizeLabel, ::innate_subsystem::Control * modTimeLabel)
    {
        char buffer[255];
        #ifdef WINDOWS
