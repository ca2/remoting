...
// // OleClientSite g_clientSite;
   ...
   ::pointer < ::windows::client_site > g_pclientsite;
   ::pointer < ::remoting_rdx_client::main_window > g_pmainwindow;
   ::pointer < ::win32::acme::windowing::window> g_pwindow;
...
// void ResizeActiveX()
// {
//     if (!g_pclientsite->m_pinplacesite->m_pinplaceframe->m_pinplaceobject)
//         return;
//
//     RECT rc;
//     GetClientRect(g_hwndMain, &rc);
//
//     g_pclientsite->m_pinplacesite->m_pinplaceframe->m_pinplaceobject->SetObjectRects(&rc, &rc);
// }
//
// // ============================================================================
...
//
//    g_pclientsite->initialize_client_site(g_pcomwindow);
//
...
//         (void**)&g_pclientsite->m_pinplacesite->m_pinplaceframe->m_pinplaceobject);
//
//     if (FAILED(hr))
//         return hr;
//
    ...
    LPARAM lParam)
{
    ...
    case WM_CREATE:
    {
       ...
       ::system()->construct_newø(g_pmainwindow);
       ::system()->construct_newø(g_pwindow);

       g_pmainwindow->m_pacmewindowingwindow = g_pwindow;
       g_pwindow->m_pacmeuserinteraction = g_pmainwindow;

       g_pwindow->m_windowswindow = hwnd;

g_pmainwindow->on_create_window();
