...
//#include "remoting/remoting_rtc/win_system/WindowsProcessCommandLine.h"
...
namespace remoting_client
{
    ...
    protected:
       ...
       ::pointer < ::subsystem::ProcessCommandLineInterface > m_pprocesscommandlineOperatingSystem;
        ...
        ::remoting_rtc::ConnectionConfig *m_pconnectionconfig;
        ::remoting_rtc::ViewerConfig *m_config;
        bool *m_isListening;
