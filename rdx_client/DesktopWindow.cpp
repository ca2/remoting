...
{
    DesktopWindow::DesktopWindow(::subsystem::LogWriter * plogwriter, ::remoting_rtc::ConnectionConfig *pconnectionconfig, ViewerWindow * pviewerwindow) :
        ...
        m_isBackgroundDirty(false)
    {
       ...
       m_brush.initialize_solid_brush(color::black);
        ...
        m_bShowCursor = true;
       m_rfbKeySym = øraw_new ::remoting_rtc::RfbKeySym(this, m_plogwriter);
    }
   ...
   void DesktopWindow::onDraw(::innate_subsystem::GraphicsInterface * pgraphics, const ::i32_rectangle & rectangle)
    {
        ...
        if (!fbWidth || !fbHeight)
        {
            //::remoting_rtc::Graphics graphics(hdc);
