...
namespace remoting_client
{
   ...
   // new ::platform::system();
      ...
      if (!m_pviewerconfig)
      {
         ...
         auto pviewersettingsmanager = ::remoting_rtc::ViewerSettingsManager::getInstance();

         m_pviewerconfig = allocateø ::remoting_rtc::ViewerConfig(RegistryPaths::VIEWER_PATH);
