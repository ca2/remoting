...
#include "remoting/remoting_rtc/viewer_core/FileTransferCapability.h"
#include "remoting/remoting_rtc/viewer_core/RemoteViewerCore.h"
#include "remoting/remoting_rtc/viewer_core/CoreEventsAdapter.h"
#include "remoting/remoting_rtc/viewer_core/VncAuthentication.h"
...
namespace remoting_client
{
   ...
   public:
      ...
      ::pointer < ::subsystem::LogWriter > m_plogwriter;
       ...
       ::remoting_rtc::ConnectionConfigSM m_ccsm;
       ...
       //ublic :
        ...
        ViewerWindow(
           ...
           ::remoting_rtc::ConnectionConfig * pconnectionconfig,
      ...
      bool on_user_system_command(::user::enum_system_command esystemcommand) override;
        ...
        void onConnected(::remoting_rtc::RfbOutputGate *output) override;
