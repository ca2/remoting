...
private:
  void getChangedRegion(Region *rgn, const ::int_rectangle &  rect);
  void updateChangedRect(Region *rgn, const ::int_rectangle &  rect);
  void updateChangedSubRect(Region *rgn, const ::int_rectangle &  rect);
