...
public:
  ...
  static void fixAlphaChannel(const ::subsystem::FrameBuffer *pixels, char *maskAND, bool isInversedAlpha, int maskWidthInBytes);
  ...
  static void winMonoShapeToRfb(const ::subsystem::FrameBuffer *pixels, char *maskAND, char *maskXOR, int maskWidthInBytes);
  ...
  template< typename T >
  static bool winColorShapeToRfb(const ::subsystem::FrameBuffer *pixels, char *maskAND, int maskWidthInBytes);
...
private:
  ...
  static unsigned int getAlphaMask(const ::subsystem::PixelFormat & pf);
...
template< typename T >
static bool WinCursorShapeUtils::winColorShapeToRfb(const ::subsystem::FrameBuffer *pixels,
                                                    char *maskAND, int maskWidthInBytes)
{
  ...
  unsigned int alphaMask = getAlphaMask(&pf);
