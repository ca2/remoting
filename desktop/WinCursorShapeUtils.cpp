...
void WinCursorShapeUtils::winMonoShapeToRfb(const ::subsystem_apex::FrameBuffer *pixels,
...
void WinCursorShapeUtils::fixAlphaChannel(const ::subsystem_apex::FrameBuffer *pixels,
...
unsigned int WinCursorShapeUtils::getAlphaMask(const ::subsystem_apex::PixelFormat & pf)
{
  if (pf.bitsPerPixel == 32) {
