...
Section
  IfSilent 0 +2
    MessageBox ::user::e_message_box_ok|::user::e_message_box_icon_information 'This is a "silent" installer'

  # there is no need to use IfSilent for this one because the /SD switch takes care of that
  MessageBox ::user::e_message_box_ok|::user::e_message_box_icon_information "This is not a silent installer" /SD IDOK
  ...
  MessageBox ::user::e_message_box_ok|::user::e_message_box_icon_information "This message box always shows if the installer is silent"
