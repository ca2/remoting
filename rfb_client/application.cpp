...
__IMPLEMENT_APPLICATION_RELEASE_TIME(remoting_rfb_client);
IMPLEMENT_APPLICATION_FACTORY(remoting_rfb_client);
...
namespace remoting_rfb_client
{
   ...
   ::remoting_rfb_client::remoting * application::remoting()
   {
