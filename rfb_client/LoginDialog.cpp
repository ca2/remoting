...
{
   LoginDialog::LoginDialog(remoting_impact *premotingimpact, ::remoting_rfb_client::remoting *premoting) :
   ...
   {
      //::remoting_rfb::ConnectionHistory *conHistory;
      ...
      if (m_server.getItemsCount())
      {
         ...
         ::remoting_rfb::ConnectionConfigSM ccsm(RegistryPaths::VIEWER_PATH, server);
   ...
   void LoginDialog::onConnect()
   {
      ...
      if (m_serverHost.has_character())
      {
         ...
         ::remoting_rfb::ConnectionConfigSM ccsm(RegistryPaths::VIEWER_PATH, m_serverHost);
