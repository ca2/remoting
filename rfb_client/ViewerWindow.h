...
#include "remoting/remoting_rfb/viewer_core/CoreEventsAdapter.h"
#include "remoting/remoting_rfb/viewer_core/VncAuthentication.h"
...
namespace remoting_rfb_client
{
   ...
   public:
      ...
      ::pointer < ::subsystem::LogWriter > m_plogwriter;
       ...
       ::remoting_rfb::ConnectionConfigSM m_ccsm;
       ...
       //ublic :
        ...
        ::pointer < ::remoting_rfb_client::keyboard_layout_change > m_pkeyboardlayoutchange;
        ...
        void setFileTransfer(::remoting_rfb_client::file_transfer::FileTransferCapability *ft);
        void setRemoteViewerCore(::remoting_rfb_client::RemoteViewerCore *pCore);
      ...
      static const ::i32 WM_USER_DISCONNECT_NO_CONFIRM = WM_USER + 6;
      ...
      bool on_user_system_command(::user::enum_system_command esystemcommand) override;
        ...
        void onConnected(::remoting_rfb::RfbOutputGate *output) override;
        void onDisconnect(const ::scoped_string & scopedstrMessage) override;
        void onAuthError(const ::remoting_rfb_client::AuthException *exception) override;
       ...
       //bool on_keyboard_message()
        ...
        bool operating_system_hook_on_keyboard_message(::lresult & lresult, ::user::enum_message emessage, ::i32 iVkCode, ::lparam lparam) override;
