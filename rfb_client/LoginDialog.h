...
#include "remoting/remoting_rfb/client_config/ConnectionConfigSM.h"
...
namespace remoting_rfb_client
{
   ...
   class remoting;
    ...
    public:
       ...
       LoginDialog(remoting_impact *viewer, ::remoting_rfb_client::remoting *premoting);
        ~LoginDialog();

        // this function returns the host
        ::string getServerHost();
        void setConConf(::remoting_rfb::ConnectionConfig *pconnectionconfig);
        // set listening mode
