...
namespace remoting_rfb_client
{
   ...
   public:
      ...
      remoting_impact(::particle *pparticle, ::remoting_rfb_client::remoting *premoting,
      ...
      void newConnection(const ::scoped_string & hostName, ::remoting_rfb::ConnectionConfig * pconnectionconfig);
      void newConnection(ConnectionData * pconnectiondata, ::remoting_rfb::ConnectionConfig * pconnectionconfig);
...
void defer_check_dead_instance();
      ...
      void runInstance(ConnectionData * pconnectiondata, ::remoting_rfb::ConnectionConfig * pconnectionconfig);
      void runInstance(const ::scoped_string & hostName, ::remoting_rfb::ConnectionConfig * pconnectionconfig);
