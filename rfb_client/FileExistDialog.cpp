...
namespace remoting_rfb_client
{
    ...
    void FileExistDialog::setFilesInfo(::remoting_rfb::file_transfer::FileInfo *existingFileInfo, ::remoting_rfb::file_transfer::FileInfo *newFileInfo,
    ...
    void FileExistDialog::updateGui(::remoting_rfb::file_transfer::FileInfo *fileInfo, ::innate_subsystem::Control *sizeLabel, ::innate_subsystem::Control * modTimeLabel)
    {
        char buffer[255];
        #ifdef WINDOWS
