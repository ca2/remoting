...
namespace remoting_rfb_client
{
   ...
   // new ::platform::system();
      ...
      if (!m_pviewerconfig)
      {
         ...
         auto pviewersettingsmanager = ::remoting_rfb::ViewerSettingsManager::getInstance();

         m_pviewerconfig = allocateø ::remoting_rfb::ViewerConfig(RegistryPaths::VIEWER_PATH);
