...
#include "remoting/remoting_rfb/rfb/RfbKeySym.h"
...
namespace remoting_rfb_client
{
    ...
    class DesktopWindow : public ::innate_subsystem::Window,
                          protected ::remoting_rfb::RfbKeySymListener
    {
    public:
       ...
       ::pointer < ViewerWindow > m_pviewerwindow;
        ...
        DesktopWindow(::subsystem::LogWriter * plogwriter, ::remoting_rfb::ConnectionConfig * pconnectionconfig, ViewerWindow * pviewerwindow);
    ...
    public:
       ...
       //void on_set_cursor_rectangles() override;
        ...
        bool m_ctrlDown;
        bool m_altDown;
        ::pointer < ::remoting_rfb_client::RemoteViewerCore > m_premoteviewercore;
