...
//#include "remoting/remoting_rfb/win_system/WindowsProcessCommandLine.h"
...
namespace remoting_rfb_client
{
    ...
    protected:
       ...
       ::pointer < ::subsystem::ProcessCommandLineInterface > m_pprocesscommandlineOperatingSystem;
        ...
        ::remoting_rfb::ConnectionConfig *m_pconnectionconfig;
        ::remoting_rfb::ViewerConfig *m_config;
        bool *m_isListening;
