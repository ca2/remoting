...
namespace remoting_rfb_client
{
   ...
   void remoting_impact::runInstance(const ::scoped_string & hostName, ::remoting_rfb::ConnectionConfig * pconnectionconfig)
   {
   ...
   void remoting_impact::runInstance(ConnectionData * pconnectiondata, ::remoting_rfb::ConnectionConfig * pconnectionconfig)
   {
   ...
   void remoting_impact::newConnection(const ::scoped_string & hostName, ::remoting_rfb::ConnectionConfig * pconnectionconfig)
   {
   ...
   void remoting_impact::newConnection(ConnectionData * pconnectiondata, ::remoting_rfb::ConnectionConfig * pconnectionconfig)
   {
   ...
   {
      ::remoting_rfb::ConnectionConfigSM ccsm(RegistryPaths::VIEWER_PATH,
                              ".listen");
      ::remoting_rfb::ConnectionConfig conConfig;
   ...
   void remoting_impact::newListeningConnection()
   {
      ...
      auto pconnectionconfig = create_newø<::remoting_rfb::ConnectionConfig>();

      ::remoting_rfb::ConnectionConfigSM ccsm(RegistryPaths::VIEWER_PATH, ".listen");
         ...
         case _WM_USER_ABOUT:
            ...
            break;
                         case WM_USER_RECONNECT: {
                            ...
                            ::pointer <::remoting_rfb::ConnectionConfig > pconnectionconfig(lparam);
