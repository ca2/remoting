...
{
   FileTransferMainDialog::FileTransferMainDialog(::remoting_rfb::file_transfer::FileTransferCore *core)
   : FileTransferInterface(core)
   {
      ...
      m_fakeMoveUpFolder = new ::remoting_rfb::file_transfer::FileInfo(0, 0, ::remoting_rfb::file_transfer::FileInfo::DIRECTORY, "..");
   }
   ...
   ::i32 FileTransferMainDialog::onFtTargetFileExists(::remoting_rfb::file_transfer::FileInfo *sourceFileInfo,
                                                    ::remoting_rfb::file_transfer::FileInfo *targetFileInfo,
                                                    const ::file::path & pathToTargetFile)
   {
      ...
      switch (reasonOfDialog) {
         case FileExistDialog::SKIP_RESULT:
            return ::remoting_rfb::file_transfer::CopyFileEventListener::TFE_SKIP;
         case FileExistDialog::APPEND_RESULT:
            return ::remoting_rfb::file_transfer::CopyFileEventListener::TFE_APPEND;
         case FileExistDialog::CANCEL_RESULT:
            onCancelOperationButtonClick();
            return ::remoting_rfb::file_transfer::CopyFileEventListener::TFE_CANCEL;
      } // switch

      return ::remoting_rfb::file_transfer::CopyFileEventListener::TFE_OVERWRITE;
   }
...
// });
   ...
   bool FileTransferMainDialog::_002OnSelectionChange(::i32 iControl)
   {
    ...
    {
        ::remoting_rfb::file_transfer::FileInfo *fileInfo = m_remoteFileListView.getSelectedFileInfo();
      ...
      renameDialog.initialize_file_rename_dialog(this);
        ...
        if (renameDialog.showModal() == ::innate_subsystem::e_control_id_ok) {
            ...
            m_ftCore->remoteFileRenameOperation(::remoting_rfb::file_transfer::FileInfo(0, 0, ::remoting_rfb::file_transfer::FileInfo::DIRECTORY, oldName),
                                                ::remoting_rfb::file_transfer::FileInfo(0, 0, ::remoting_rfb::file_transfer::FileInfo::DIRECTORY, newName),
                                                remoteFolder);
        }
    }
    ...
    void FileTransferMainDialog::onMkDirRemoteButtonClick()
    {
      ...
      folderDialog.initialize_new_folder_dialog(this);
        if (folderDialog.showModal() == ::innate_subsystem::e_control_id_ok) {
            ...
            m_ftCore->remoteFolderCreateOperation(::remoting_rfb::file_transfer::FileInfo(0, 0,
                                                          ::remoting_rfb::file_transfer:: FileInfo::DIRECTORY,
                                                           fileName),
                                                  remoteFolder);
        }
    }
    ...
    void FileTransferMainDialog::onRemoveRemoteButtonClick()
    {
        ...
        //::remoting_rfb::file_transfer::FileInfo *filesInfo = new ::remoting_rfb::file_transfer::FileInfo[siCount];

        ::pointer_array< ::remoting_rfb::file_transfer::FileInfo> fileinfoa;

        auto indexes = m_remoteFileListView.getSelectedItemsIndexes();
        for (::u32 i = 0; i < indexes.size(); i++) {
            ::remoting_rfb::file_transfer::FileInfo * pfileinfo = reinterpret_cast<::remoting_rfb::file_transfer::FileInfo *>(m_remoteFileListView.getItemData(indexes[i]).m_lparam);
    ...
    {
        ::remoting_rfb::file_transfer::FileInfo *fileInfo = m_localFileListView.getSelectedFileInfo();
    ...
    void FileTransferMainDialog::onRemoveLocalButtonClick()
    {
        ...
        for (::u32 i = 0; i < indexes.size(); i++) {
            auto pfileInfo = m_localFileListView.getItemData(indexes[i]).raw_cast<::remoting_rfb::file_transfer::FileInfo*>();
            fileinfoa.add(pfileInfo);
        }
    ...
    void FileTransferMainDialog::onDownloadButtonClick()
    {
      ...
      L"No files selected.",
        ...
        for (::u32 i = 0; i < indexes.size(); i++) {
            auto pfileInfo = m_remoteFileListView.getItemData(indexes[i]).raw_cast<::remoting_rfb::file_transfer::FileInfo *>();
            fileinfoa.add(pfileInfo);
        }
    ...
    {
        ::remoting_rfb::file_transfer::FileInfo *selFileInfo = m_remoteFileListView.getSelectedFileInfo();
        if (selFileInfo == 0)
            return;
    ...
    void FileTransferMainDialog::onLocalListViewDoubleClick()
    {
        ...
        ::remoting_rfb::file_transfer::FileInfo *selFileInfo = m_localFileListView.getSelectedFileInfo();
    ...
    {
        try {
            //::array_base <::remoting_rfb::file_transfer::FileInfo> *localFileList = m_ftCore->getListLocalFolder(pathToFile);
            ...
            {
                //::remoting_rfb::file_transfer::FileInfo *fileInfo = localFileList->data();
    ...
    void FileTransferMainDialog::setNothingState()
    {
        ...
        if (fileRemoteList.has_element()) {
            //::remoting_rfb::file_transfer::FileInfo *filesInfo = fileRemoteList->data();
