...
#include "remoting/remoting_rfb/resource.h"
...
namespace remoting_rfb_client
{
    ...
    void FileInfoListView::addItem(::i32 index, ::remoting_rfb::file_transfer::FileInfo *fileInfo)
    {
    ...
    //void FileInfoListView::addRange(::remoting_rfb::file_transfer::FileInfo **filesInfo, size_t count)
    void FileInfoListView::addRange(const ::pointer_array < ::remoting_rfb::file_transfer::FileInfo > & fileinfoa)
    {
        //::i32 index = maximum(0, (getCount() - 1));
        auto i = maximum(0, getCount() - 1);
        //size_t i = 0;
        //::remoting_rfb::file_transfer::FileInfo *arr = *filesInfo;

        // Add folders first
        for (auto & pinfo : fileinfoa) {
            //::remoting_rfb::file_transfer::FileInfo *fi = &arr[i];
    ...
    ::pointer<::remoting_rfb::file_transfer::FileInfo > FileInfoListView::getSelectedFileInfo()
    {
        ...
        ::cast < ::remoting_rfb::file_transfer::FileInfo> pfileinfo = pparticle;
        return pfileinfo;
    }
...
//       auto pcompare = (compare_t*) pCompare;
  ...
  //     auto lParamSort = pcompare->m_lparamSort;
        ...
        ::remoting_rfb::file_transfer::FileInfo *firstItem = (::remoting_rfb::file_transfer::FileInfo *)(lParam1.m_lparam);
        ::remoting_rfb::file_transfer::FileInfo *secondItem = (::remoting_rfb::file_transfer::FileInfo *)(lParam2.m_lparam);
        ...
        if (sortAscending) {
           firstItem = (::remoting_rfb::file_transfer::FileInfo *)(lParam1.m_lparam);
           secondItem = (::remoting_rfb::file_transfer::FileInfo *)(lParam2.m_lparam);
        } else {
           firstItem = (::remoting_rfb::file_transfer::FileInfo *)(lParam1.m_lparam);
           secondItem = (::remoting_rfb::file_transfer::FileInfo *)(lParam2.m_lparam);
