...
namespace remoting_rfb_client
{
    ...
    public:
       ...
       virtual bool we_want_WM_KEYDOWN_when_enter_is_pressed() const override;
        ...
        virtual void addItem(int index, ::remoting_rfb::file_transfer::FileInfo *fileInfo);

        //
        // Adds files info array to the end of ::list_base view
        //

        //void addRange(::remoting_rfb::file_transfer::FileInfo **filesInfo, size_t count);
        virtual void addRange(const ::pointer_array < ::remoting_rfb::file_transfer::FileInfo > & fileinfoa);

        //
        // Returns file info notated by first selected ::list_base view item
        //

        virtual ::pointer < ::remoting_rfb::file_transfer::FileInfo >getSelectedFileInfo();
