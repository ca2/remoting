...
#include "remoting/remoting_rfb/file_transfer_client/FileTransferInterface.h"

//#include aaa_<vector>
namespace remoting_rfb_client
{
    class FileTransferMainDialog : public ::innate_subsystem::Dialog,
                                   public ::remoting_rfb::file_transfer::FileTransferInterface
    {
    public:
        FileTransferMainDialog(::remoting_rfb::file_transfer::FileTransferCore *core);
        ...
        //
        int onFtTargetFileExists(::remoting_rfb::file_transfer::FileInfo *sourceFileInfo,
        ...
        ::remoting_rfb::file_transfer:: FileInfo *m_fakeMoveUpFolder;
