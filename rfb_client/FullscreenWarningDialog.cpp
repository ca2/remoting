...
{
    FullscreenWarningDialog::FullscreenWarningDialog(::remoting_rfb_client::remoting * premoting) : m_premoting(premoting)
    {
...
FullscreenWarningDialog::~FullscreenWarningDialog()
{
   ...
   bool FullscreenWarningDialog::onCommand(::u32 controlID, ::u32 notificationID)
   {
      ...
      if (controlID == ::innate_subsystem::e_control_id_ok) 
      {
         ...
         pviewerconfig->saveToStorage(::remoting_rfb::ViewerSettingsManager::getInstance());
         closeDialog(1);
         return true;
