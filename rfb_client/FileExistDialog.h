...
namespace remoting_rfb_client
{
    ...
    public:
        ...
        void setFilesInfo(::remoting_rfb::file_transfer::FileInfo *existingFileInfo, ::remoting_rfb::file_transfer::FileInfo *newFileInfo,
    ...
    //protected:
        ...
        virtual void updateGui(::remoting_rfb::file_transfer::FileInfo *fileInfo, ::innate_subsystem::Control *sizeLabel, ::innate_subsystem::Control *modTimeLabel);
        virtual void initControls();

        //protected:
        ::remoting_rfb::file_transfer::FileInfo *m_newFileInfo;
        ::remoting_rfb::file_transfer:: FileInfo *m_existingFileInfo;
