...
public:
  ...
  inline void setRect(const ::int_rectangle &  rect)
  {
    left    = rect.left;
    top     = rect.top;
    right   = rect.right;
  ...
  inline ::int_rectangle & operator=(const ::int_rectangle &rect)
  {
    setRect(rect);
    return *this;
  }
  ...
  inline bool isEqualTo(const ::int_rectangle &  rect)  const { return  rect.left == left &&
                                                    rect.top == top &&
                                                    rect.right == right &&
                                                    rect.bottom == bottom; }
