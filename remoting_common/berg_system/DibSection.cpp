...
DibSection::DibSection(const ::subsystem::PixelFormat & pf, const ::int_size & dim, HWND compatibleWin)
...
void DibSection::setupBMIStruct(BITMAPINFO *pBmi, const ::subsystem::PixelFormat & pf, const ::int_size & dim)
{
...
void DibSection::openDIBSection(const ::subsystem::PixelFormat & pf, const ::int_size & dim, HWND compatibleWin)
{
