...
public:
  ...
  // the DIB section.
  DibSection(const ::subsystem::PixelFormat & pf, const ::int_size & dim, HWND compatibleWin = 0);
  virtual ~DibSection();
...
private:
  ...
  void openDIBSection(const ::subsystem::PixelFormat & pf, const ::int_size & dim, HWND compatibleWin);
