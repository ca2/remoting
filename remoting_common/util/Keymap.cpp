...
const unsigned int EXTENDED_KEYS[] = {
  XK_Control_R,
  XK_Alt_R,
...
bool Keymap::keySymToUnicodeChar(unsigned int keySym, WCHAR *ch)
{
...
bool Keymap::unicodeCharToKeySym(WCHAR ch, unsigned int *keySym)
{
  // Latin-1 characters.
