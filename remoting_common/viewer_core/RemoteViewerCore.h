...
namespace remoting
{
   ...
   public:
      ...
      //
      void setPixelFormat(const ::subsystem_apex::PixelFormat & viewerPixelFormat);
      ...
      //
      ::subsystem_apex::PixelFormat readPixelFormat();
      ...
      ::subsystem_apex::FrameBuffer m_rectangleFb;

      critical_section m_pixelFormatLock;
      bool m_isNewPixelFormat;
      ::subsystem_apex::PixelFormat m_viewerPixelFormat;
