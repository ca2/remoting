...
//      waitThreadToFinish();
      ...
      //  m_puserinput(0), m_pdesktopconfigclient(0), m_pgatekicker(0), m_plogwriter(plogwriter)
   {
      ...
      //::remoting_rfb::DesktopBaseImpl::initialize_desktop(pconfigurator, pclipboardlistenerExternal, pupdatesendinglistenerExternal, pdesktermlistenerExternal, plogwriter);
      ...
      try
      {
         ...
         m_plogwriter->debug("DesktopClientImpl: Initializing UserInputClient...");
         //UserInputClient *userInputClient = new UserInputClient(m_pgateClientToServer, m_pdesktopsrvdispatcher, this);
         auto puserinputclient =allocateø ::remoting_rfb::UserInputClient();
   ...
   {
      ::remoting_rfb::BlockingGate pblockinggate(newChannelTo);
      if (m_pdesktopconfigclient)
      {
