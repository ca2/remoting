...
namespace remoting_rfb_windows
{
   ...
   class CLASS_DECL_REMOTING_RFB Poller :
   ...
   public:
      ...
      // Poller(::remoting_rfb::UpdateKeeper * pupdatekeeper, ::remoting_rfb::UpdateListener * pupdatelistener, ScreenGrabber *pscreengrabber,
      ...
      virtual void initialize_poller(::remoting_rfb::UpdateKeeper * pupdatekeeper, ::remoting_rfb::UpdateListener * pupdatelistener, ScreenGrabber *pscreengrabber,
       ::innate_subsystem::Framebuffer *backupFramebuffer, lockable_critical_section *framebufferCriticalSection,
       ::subsystem::LogWriter * plogwriter);
