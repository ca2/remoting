...
namespace remoting_rfb_windows
{
   ...
   void ::remoting_rfb::UpdateKeeper::addChangedRegion(const Region & regionChanged)
   {
   ...
   void ::remoting_rfb::UpdateKeeper::addChangedRect(const ::i32_rectangle &rectangleChanged)
   {
      Region region(rectangleChanged);
      addChangedRegion(region);
   }

   void ::remoting_rfb::UpdateKeeper::addCopyRect(const ::i32_rectangle &rectangleCopy, const ::i32_point &pointSource)
   {
      critical_section_lock al(&m_criticalsectionUpdateContainer);
   ...
   void ::remoting_rfb::UpdateKeeper::setBorderRect(const ::i32_rectangle &borderRect)
   {
      critical_section_lock al(&m_criticalsectionUpdateContainer);
      m_rectangleBorder = borderRect;
   }

   void ::remoting_rfb::UpdateKeeper::setScreenSizeChanged()
   {
      critical_section_lock al(&m_criticalsectionUpdateContainer);
      m_updatecontainer.m_bScreenSizeChanged = true;
   }

   void ::remoting_rfb::UpdateKeeper::setCursorPosChanged()
   {
      critical_section_lock al(&m_criticalsectionUpdateContainer);
      m_updatecontainer.m_bCursorPosChanged = true;
   }

   void ::remoting_rfb::UpdateKeeper::setCursorPos(const ::i32_point &curPos)
   {
      critical_section_lock al(&m_criticalsectionUpdateContainer);
      m_updatecontainer.m_bCursorPosChanged = true;
   ...
   void ::remoting_rfb::UpdateKeeper::setCursorShapeChanged()
   {
      critical_section_lock al(&m_criticalsectionUpdateContainer);
      m_updatecontainer.m_bCursorShapeChanged = true;
   }

   void ::remoting_rfb::UpdateKeeper::addUpdateContainer(const UpdateContainer & updatecontainer)
   {
      critical_section_lock al(&m_criticalsectionUpdateContainer);
   ...
   void ::remoting_rfb::UpdateKeeper::getUpdateContainer(UpdateContainer & updatecontainer)
   {
      critical_section_lock al(&m_criticalsectionUpdateContainer);
      updatecontainer = m_updatecontainer;
   }

   bool ::remoting_rfb::UpdateKeeper::checkForUpdates(const Region & region)
   {
   ...
   void ::remoting_rfb::UpdateKeeper::extract(UpdateContainer & updatecontainer)
   {
      {
         critical_section_lock al(&m_criticalsectionUpdateContainer);
   ...
   void ::remoting_rfb::UpdateKeeper::setExcludedRegion(const Region & regionExcluded)
   {
      critical_section_lock al(&m_criticalsectionExclRegLoc);
   ...
   void ::remoting_rfb::UpdateKeeper::clearExcludedRegion()
   {
      critical_section_lock al(&m_criticalsectionExclRegLoc);
