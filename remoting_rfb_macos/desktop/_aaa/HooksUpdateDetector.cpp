...
//    HooksUpdateDetector::HooksUpdateDetector(::remoting_rfb::UpdateKeeper * pupdatekeeper, ::remoting_rfb::UpdateListener * pupdatelistener,
...
//    }
   ...
   void HooksUpdateDetector::initialize_hooks_update_detector(::remoting_rfb::UpdateKeeper * pupdatekeeper, ::remoting_rfb::UpdateListener * pupdatelistener, ::subsystem::LogWriter * plogwriter)
   {
