...
namespace remoting_rfb_windows
{
   ...
   */
   ...
   class CLASS_DECL_REMOTING_RFB_WINDOWS WindowsScreenGrabber :
   virtual public ::remoting_rfb::ScreenGrabber,
   virtual public ::subsystem::GuiThread
   {
   public:
      //WindowsScreenGrabber(::remoting_rfb_node::Configurator * pconfigurator);
      WindowsScreenGrabber();
      ~WindowsScreenGrabber() override;

      virtual void initialize_screen_grabber(::remoting_rfb_node::Configurator * pconfigurator);
      ...
      ::remoting_rfb_node::ServerConfig *m_pserverconfig;
