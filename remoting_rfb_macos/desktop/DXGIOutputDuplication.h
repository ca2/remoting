...
#include "remoting/remoting_rfb_windows/desktop/aaa_WinDxgiOutput1.h"
...
namespace remoting_rfb_windows
{
   ...
   class CLASS_DECL_REMOTING_RFB_WINDOWS DXGIOutputDuplication :
   ...
   public:
      ...
      void getFrameCursorShape(::remoting_rfb::CursorShape *cursorShape, ::u32 pointerShapeBufferSize,
