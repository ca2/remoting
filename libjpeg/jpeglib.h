...
/* The decompressor can save APPn and COM markers in a ::std::list of these: */

typedef struct jpeg_marker_struct FAR * jpeg_saved_marker_ptr;

struct jpeg_marker_struct {
  jpeg_saved_marker_ptr next;	/* next in ::std::list, or NULL */
...
struct jpeg_decompress_struct {
   ...
   * can be saved in a ::std::list for examination by the application.
   */
  jpeg_saved_marker_ptr marker_list; /* Head of ::std::list of saved markers */
...
#define JMSG_STR_PARM_MAX  80
   ...
   * message ::std::list (typically, to change the language in which errors are
