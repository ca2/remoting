...
public:
  ...
  void init(const ::int_size & viewPortDimension, const ::subsystem_apex::PixelFormat & pf);
...
protected:
  ...
  // Access to a ::subsystem_apex::FrameBuffer data passes through the frameBuffer pointer
  ...
  // by a client.
  void sendPalette(::subsystem_apex::PixelFormat *pf);
  ...
  void setClientPixelFormat(const ::subsystem_apex::PixelFormat & pf,
                            bool clrMapEntries);
  ...
  void sendCursorShapeUpdate(const ::subsystem_apex::PixelFormat & fmt,
                             const CursorShape *cursorShape);
  ...
  void paintBlack(::subsystem_apex::FrameBuffer *frameBuffer, const Region *blackRegion);
  ...
  // framebuffer update.
  ::subsystem_apex::PixelFormat m_newPixelFormat;
