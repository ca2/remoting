...
#include "remoting/remoting_rfb/node/RemoteException.h"
...
namespace remoting_control_desktop
{
    ...
    * Used to onThreadMain remote commands on on Remoting Node.
    * remote errors.
    */
   class ControlProxy :
   ...
   public:
       ...
       * @throws ::io_exception on io error.
       */
      void setServerConfig(::remoting_rfb_node::ServerConfig * pserverconfig);
       ...
       * @throws ::io_exception on io error.
       */
      void getServerConfig(::remoting_rfb_node::ServerConfig * pserverconfig);
