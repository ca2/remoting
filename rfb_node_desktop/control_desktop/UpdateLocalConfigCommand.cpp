...
{
   UpdateLocalConfigCommand::UpdateLocalConfigCommand(::remoting_rfb_node::Configurator * pconfigurator, ControlProxy *proxy)
   ...
   void UpdateLocalConfigCommand::onRunCommand()
   {
