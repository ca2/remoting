...
namespace remoting_control_desktop
{
   ...
   ControlTrayIcon::ControlTrayIcon(::remoting_rfb_node::Configurator * pconfigurator, ControlProxy *pcontrolproxy,
                                    ::remoting_rfb_node::Notificator *notificator,
...
initialize(::system());
      ...
      m_pcontrolcommandApplyChanges = allocateø ::remoting_rfb_node::ControlCommand(m_pmacrocommandApplyChanges, m_pnotificator);

      // Create config dialog.
      m_pconfigdialog = allocateø ::remoting_rfb_node::ConfigDialog(m_pconfigurator);
...
void ControlTrayIcon::onAction(::i32 action)
{
   ...
   void ControlTrayIcon::onConfigurationMenuItemClick()
   {
      ...
      if (!m_pconfigdialog->isCreated()) {
         ...
         ::remoting_rfb_node::ControlCommand safeCommand(&updateLocalConfigCommand, m_pcontrolapplication);
   ...
   void ControlTrayIcon::onDisconnectAllClientsMenuItemClick()
   {
      ...
      ::remoting_rfb_node::ControlCommand safeCommand(&unsafeCommand, m_pnotificator);
