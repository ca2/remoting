...
{
   UpdateRemoteConfigCommand::UpdateRemoteConfigCommand(::remoting_rfb_node::Configurator * pconfigurator, ControlProxy * pcontrolproxy)
   ...
   void UpdateRemoteConfigCommand::onRunCommand()
   {
