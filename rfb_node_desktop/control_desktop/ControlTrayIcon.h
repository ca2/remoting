...
namespace remoting_control_desktop
{
   ...
   public:
       ...
       */
      ControlTrayIcon(::remoting_rfb_node::Configurator * pconfigurator,
   ...
   protected:
      ...
      ::pointer < ::remoting_rfb_node::Notificator > m_pnotificator;
      ...
      ::pointer < ::remoting_rfb_node::ConfigDialog > m_pconfigdialog;
      // About dialog.
      ...
      ::pointer < ::remoting_rfb_node::ControlCommand  > m_pcontrolcommandApplyChanges;
