...
#include "remoting/rfb_node_desktop/ServerListener.h"
//#include "WsConfigRunner.h"
// #include "log_writer/FileLogWriter.h"
#include "remoting/rfb_node_desktop/LogInitListener.h"
...
namespace remoting_rfb_node_desktop
{
    ...
    */
   class CLASS_DECL_REMOTING_RFB_NODE_DESKTOP Task : 
   ...
   public:
      ...
      virtual void initialize_remoting_node_desktop_server_task(::remoting_rfb_node::NewConnectionEvents * pnewconnectionevents);
