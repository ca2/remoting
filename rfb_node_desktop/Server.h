...
//#include "remoting/remoting_rfb/desktop/ApplicationDesktopFactory.h"
...
#include "remoting/rfb_node_desktop/control_desktop/ServerInfo.h"
...
namespace remoting_rfb_node_desktop
{
   ...
   class  CLASS_DECL_REMOTING_RFB_NODE_DESKTOP Server : 
   ...
   public:
      ...
      //::pointer < ::remoting_rfb::WinServiceDesktopFactory > m_pservicedesktopfactory;
      //::pointer < ::remoting_rfb::ApplicationDesktopFactory > m_papplicationdesktopfactory;
      ::pointer < ::remoting_rfb::DesktopFactory > m_pdesktopfactory;
      /**
      ...
      virtual void initialize_remoting_node_desktop_server(bool runsInServiceContext, ::remoting_rfb_node::NewConnectionEvents *newConnectionEvents,
   ...
   //protected:
      ...
      // * Shortcut to global server configuration.
      // */
      //::remoting_rfb_node::ServerConfig *m_srvConfig;
