...
namespace remoting_rfb_node_desktop
{
   ...
   void QueryConnectionApplication::initialize_query_connection_application(::remoting_rfb_node::Configurator * pconfigurator,  const ::scoped_string &scopedstrCmdLine)
