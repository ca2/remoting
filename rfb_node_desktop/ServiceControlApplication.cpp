...
namespace remoting_rfb_node_desktop
{
   ...
   void ServiceControlApplication::setTvnControlStartEntry()
   {
      ...
      ::subsystem::RegistryKey runKey(MainSubsystem().Registry().getLocalMachineKey(),
                         ...
                         false);
      runKey.setValueAsString(::remoting_rfb_node::ServiceNames::TVNCONTROL_START_REGISTRY_ENTRY_NAME,
                              pathToTvnControl);
   }
   ...
   void ServiceControlApplication::removeTvnControlStartEntry()
   {
      ::subsystem::RegistryKey runKey(MainSubsystem().Registry().getLocalMachineKey(),
                         "SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Run",
                         false);
      runKey.deleteValue(::remoting_rfb_node::ServiceNames::TVNCONTROL_START_REGISTRY_ENTRY_NAME);
   }
