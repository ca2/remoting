...
#include "remoting/rfb_node_desktop/Task.h"
...
namespace remoting_rfb_node_desktop
{
    ...
    * Remoting service.
    *
    * Solves problems of installing, reinstalling, removing, starting, stopping remoting_rfb_node
    * from service control manager.
    *
    * Also contains body of tvnservice.
    */
   class CLASS_DECL_REMOTING_RFB_NODE_DESKTOP Service : 
   ...
   //protected:
      ...
      /**
       * Command line key which needed to start remoting_rfb_node binary as service.
       */
   ...
   //public:
      ...
      virtual void initialize_remoting_node_desktop_service(ServiceEvents *winServiceEvents, ::remoting_rfb_node::NewConnectionEvents *newConnectionEvents);
      ...
      /**
       * Installs remoting_rfb_node service.
       * @throws SystemException on fail.
       */
      static void install();
      /**
       * Stops and removes remoting_rfb_node service.
       * @throws SystemException when failed to remove service.
       */
      static void remove();
      /**
       * Reinstalls remoting_rfb_node service (combite call of remove and install methods).
       * @remark ignores if remove call throws exception.
       * @throws SystemException when fail to install service.
       */
      static void reinstall();
      /**
       * Starts remoting_rfb_node service.
      ...
      /**
       * Stopps remoting_rfb_node service.
       * @param waitCompletion if true, waitThreadToFinish until the status becomes
       *   SERVICE_STOPPED.
       * @throws SystemException on fail.
       */
   ...
   //protected:
       ...
       * Starts remoting_rfb_node execution.
      ...
      /**
       * Inherited from superclass.
       * Stops remoting_rfb_node execution.
       */
      //virtual void onStop() override;

      /**
       * Creates path to binary of remoting_rfb_node service.
