...
#include "remoting/rfb_node_desktop/Service.h"
#include "remoting/rfb_node_desktop/ServerApplication.h"
#include "remoting/rfb_node_desktop/QueryConnectionApplication.h"
#include "remoting/rfb_node_desktop/DesktopServerApplication.h"
#include "remoting/rfb_node_desktop/AdditionalActionApplication.h"
#include "remoting/rfb_node_desktop/ServiceControlApplication.h"
#include "remoting/rfb_node_desktop/ServiceControlCommandLine.h"
#include "remoting/rfb_node_desktop/QueryConnectionCommandLine.h"
#include "remoting/rfb_node_desktop/DesktopServerCommandLine.h"

#include "remoting/rfb_node_desktop/control_desktop/ControlApplication.h"
#include "remoting/rfb_node_desktop/control_desktop/ControlCommandLine.h"
...
#include "remoting/rfb_node_desktop/EventLogWriter.h"
...
// TvnService::SERVICE_COMMAND_LINE_KEY = "-service"
  ...
  // Check if need to start additional application that packed into remoting_rfb_node.exe.
  ...
  //if (firstKey == "".isEqualTo(TvnService::SERVICE_COMMAND_LINE_KEY)) {
    ...
    try {
      ...
      auto pcontrolapplication = allocateø ::remoting_control_desktop::ControlApplication(
        ...
        ::remoting_rfb_node::WindowNames::WINDOW_CLASS_NAME,
#endif
        strCommandLine);
    ...
    try {
      QueryConnectionApplication app;
       ...
       auto pconfigurationDummy = new ::remoting_rfb_node::Configurator();
