...
#include "remoting/remoting_rfb/rfb/HostPath.h"
...
void ControlClient::destroy()
{
   ...
   void ControlClient::addClientMsgRcvd()
   {
      ...
      ::remoting_rfb::HostPath hp(connectStringAnsi, 5500);
   ...
   {
      m_pcontrolgate->writeUInt32(::remoting_control_desktop::ControlProto::REPLY_OK);
      ::remoting_rfb_node::ServerConfig cfg;
      cfg.deserialize(m_pcontrolgate);
      ::remoting_rfb_node::ServerConfig *old = m_pconfigurator->getServerConfig();
   ...
   void ControlClient::getServerConfigMsgRcvd()
   {
      ...
      ::remoting_rfb_node::ServerConfig cfg = *m_pconfigurator->getServerConfig();
   ...
   {
      m_pcontrolgate->writeUInt32(::remoting_control_desktop::ControlProto::REPLY_OK);
      ::remoting_rfb::ViewPortState dynViewPort;
