...
namespace remoting_rfb_node_desktop
{
    ...
    * @author enikey.
    */
   class CLASS_DECL_REMOTING_RFB_NODE_DESKTOP RfbServer :
   virtual public ::remoting_rfb::TcpServer
   {
   public:
      /**
       ...
       */
      RfbServer(const ::scoped_string &scopedstrBindHost, ::remoting_rfb_node::Configurator * pconfigurator, unsigned short bindPort, RfbClientManager *clientManager,
       ...
       * Checks firewall rules (@see ::remoting_rfb_node::ServerConfig class) for incoming connection
       ...
       */
      ::remoting_rfb::ViewPortState m_rectangleViewport;
