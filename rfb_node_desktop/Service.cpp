...
#include "remoting/rfb_node_desktop/ServiceEvents.h"
...
namespace remoting_rfb_node_desktop
{
   ...
   {
      m_bService = true;
      initialize_service(::remoting_rfb_node::ServiceNames::SERVICE_NAME);
   }
   ...
   void Service::install()
   {
      ...
      scManager.installService(::remoting_rfb_node::ServiceNames::SERVICE_NAME,
                               ::remoting_rfb_node::ServiceNames::SERVICE_NAME_TO_DISPLAY,
                               binPath, "");
   }
   ...
   void Service::remove()
   {
      ...
      scManager.removeService(::remoting_rfb_node::ServiceNames::SERVICE_NAME);
   }
   ...
   void Service::start(bool waitCompletion)
   {
      ...
      scManager.startService(::remoting_rfb_node::ServiceNames::SERVICE_NAME, waitCompletion);
   }
   ...
   void Service::stop(bool waitCompletion)
   {
      ...
      scManager.stopService(::remoting_rfb_node::ServiceNames::SERVICE_NAME, waitCompletion);
   }
