...
namespace remoting_rfb_node_desktop
{
    ...
    */
   class CLASS_DECL_REMOTING_RFB_NODE_DESKTOP ControlServer : public ::subsystem::Thread
   {
   public:
       ...
       */
      ControlServer(::remoting_rfb_node::Configurator * pconfigurator, ::subsystem::PipeServer *pipeServer, RfbClientManager *rfbClientManager,
