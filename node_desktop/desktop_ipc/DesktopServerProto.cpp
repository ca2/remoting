...
void DesktopServerProto::readPixelFormat(::innate_subsystem::PixelFormat *pf,
                                         BlockingGate *gate)
{
...
void DesktopServerProto::sendPixelFormat(const ::innate_subsystem::PixelFormat & pf,
                                         BlockingGate *gate)
{
...
void DesktopServerProto::sendPoint(const ::int_point *point,
                                   BlockingGate *gate)
{
...
void DesktopServerProto::readFrameBuffer(::innate_subsystem::FrameBuffer *dstFb,
...
void DesktopServerProto::sendNewPointerPos(const ::int_point newPos, unsigned char keyFlag,
                                           BlockingGate *gate)
{
...
void DesktopServerProto::readNewPointerPos(::int_point *newPos, unsigned char *keyFlag,
                                           BlockingGate *gate)
{
