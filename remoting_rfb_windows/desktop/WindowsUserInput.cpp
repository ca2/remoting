...
//         rectangle.fromWindowsRect(&rectangle);
   ...
   void WindowsUserInput::getApplicationRegion(const ::process_identifier & processidentifier, ::remoting_rfb::Region & region)
   {
      region.clear();
      ...
      while (operatingsystemwindowForeground.is_set())
      {
         ...
         if (style & WS_VISIBLE)
         {
            ...
            {
               region.subtract(::remoting_rfb::Region(rectangle));
            }
         }
