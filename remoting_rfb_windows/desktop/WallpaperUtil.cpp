...
namespace remoting_rfb_windows
{
   ...
   void WallpaperUtil::initialize_wallpaper_util(::remoting_rfb_node::Configurator * pconfigurator, ::subsystem::LogWriter *plogwriter)
   {
   ...
   void WallpaperUtil::onConfigReload(::remoting_rfb_node::ServerConfig *serverConfig) { updateWallpaper(); }
