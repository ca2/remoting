...
namespace remoting_windows
{
   ...
   {
   public:
      //UpdateFilter(::remoting_rfb::ScreenDriver *screenDriver, ::innate_subsystem::Framebuffer *pframebuffer,
        //           lockable_critical_section *framebufferCriticalSection, ::subsystem::LogWriter * plogwriter);
      UpdateFilter();
      ~UpdateFilter();

      virtual void initialize_update_filter(::remoting_rfb::ScreenDriver *screenDriver, ::innate_subsystem::Framebuffer *pframebuffer,
             lockable_critical_section *framebufferCriticalSection, ::subsystem::LogWriter * plogwriter);

      void filter(UpdateContainer & updatecontainer);

   //private:
      void getChangedRegion(::remoting_rfb::Region & rgn, const ::i32_rectangle & rectangle);
      void updateChangedRect(::remoting_rfb::Region & rgn, const ::i32_rectangle & rectangle);
      void updateChangedSubRect(::remoting_rfb::Region & rgn, const ::i32_rectangle & rectangle);
      ...
      ::remoting_rfb::ScreenDriver *m_pscreendriver;
