...
namespace remoting_windows
{
   ...
   class CLASS_DECL_REMOTING_RFB CursorPositionDetector :
   ...
   public:
      ...
      virtual void initialize_cursor_position_detector(::remoting_rfb::UpdateKeeper * pupdatekeeper, ::remoting_rfb::UpdateListener * pupdatelistener, ::subsystem::LogWriter * plogwriter);
