...
namespace remoting_rfb_windows
{
   ...
   class CLASS_DECL_REMOTING_RFB UpdateHandlerImpl :
      virtual public UpdateHandler,
      virtual public ::remoting_rfb::UpdateListener
   {
   public:
      ::pointer < ::remoting_rfb::UpdateKeeper > m_pupdatekeeperProperty;
      ::pointer < ::remoting_rfb::ScreenDriver > m_pscreendriver;
      ::pointer < UpdateFilter > m_pupdatefilter;
      ::pointer < ::remoting_rfb::UpdateListener > m_pupdatelistenerExternal;
      ...
      UpdateHandlerImpl(::remoting_rfb::UpdateListener *pupdatelistenerExternal, ScreenDriverFactory *pscreendriverfactory,
