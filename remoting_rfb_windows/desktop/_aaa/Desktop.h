...
#include "remoting/remoting_rfb/framebuffer_update_sender/UpdateRequestListener.h"
//#include aaa_<vector>
...
namespace remoting_rfb_windows
{
   ...
   class CLASS_DECL_REMOTING_RFB Desktop : public ::remoting_rfb::UpdateRequestListener
   {
   public:
      virtual ~Desktop() {}
      ...
      virtual void getApplicationRegion(::u32 procId, ::remoting_rfb::Region & region) = 0;
