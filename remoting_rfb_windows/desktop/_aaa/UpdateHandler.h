...
namespace remoting_rfb_windows
{
   ...
   class CLASS_DECL_REMOTING_RFB UpdateHandler :
   ...
   public:
      ...
      virtual void setFullUpdateRequested(const ::remoting_rfb::Region & region) = 0;

      // Checking a region for updates.
      // Return:
      //   true - if updates presents,
      //   false - if not.
      virtual bool checkForUpdates(::remoting_rfb::Region & region) = 0;
      ...
      virtual void setExcludedRegion(const ::remoting_rfb::Region & regionExcluded) = 0;
      ...
      const ::remoting_rfb::CursorShape *getCursorShape() const { return &m_cursorshape; }
      ...
      virtual bool updateExternalFramebuffer(::innate_subsystem::Framebuffer *pframebuffer, const ::remoting_rfb::Region & region,
      ...
      virtual void sendInit(::remoting_rfb::BlockingGate *pblockinggate) {}

   protected:
      virtual bool updateExternalFramebuffer(::innate_subsystem::Framebuffer *pframebufferTarget,
                                             ::innate_subsystem::Framebuffer *pframebufferSource, const ::remoting_rfb::Region & region,
                                             const ::i32_rectangle &rectangleViewport);
