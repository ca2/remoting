...
namespace remoting_rfb_windows
{
   ...
   bool GrabOptimizator::grab(const Region & regionGrab, ::remoting_rfb::ScreenDriver *grabber)
   {
   ...
   bool GrabOptimizator::getOptimizationAvailable(::remoting_rfb::ScreenDriver *grabber)
   {
   ...
   void GrabOptimizator::refreshStatistic(::remoting_rfb::ScreenDriver *grabber)
   {
   ...
   __int64 GrabOptimizator::grabWhole(::remoting_rfb::ScreenDriver *grabber)
   {
   ...
   __int64 GrabOptimizator::grabOneRect(const ::i32_rectangle & rectangle, ::remoting_rfb::ScreenDriver *grabber)
   {
   ...
   __int64 GrabOptimizator::grabFragments(const ::i32_rectangle_array_base & rectanglea, ::remoting_rfb::ScreenDriver *grabber)
   {
      // FIXME: WARNING!!! The microsoft API usage!!!
      LARGE_INTEGER timeBegin, timeEnd;
      bool timerResult1 = QueryPerformanceCounter(&timeBegin) != 0;
