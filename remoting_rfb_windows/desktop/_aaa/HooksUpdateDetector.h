...
namespace remoting_windows
{
   ...
   class CLASS_DECL_REMOTING_RFB HooksUpdateDetector :
   virtual public UpdateDetector
   {
   public:
      //HooksUpdateDetector(::remoting_rfb::UpdateKeeper * pupdatekeeper, ::remoting_rfb::UpdateListener * pupdatelistener, ::subsystem::LogWriter * plogwriter);
      HooksUpdateDetector();
      ~HooksUpdateDetector() override;


      virtual void initialize_hooks_update_detector(::remoting_rfb::UpdateKeeper * pupdatekeeper, ::remoting_rfb::UpdateListener * pupdatelistener, ::subsystem::LogWriter * plogwriter);
