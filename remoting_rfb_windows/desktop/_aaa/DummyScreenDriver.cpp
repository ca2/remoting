...
namespace remoting_rfb_windows
{
   ...
   //
   // DummyScreenDriver::DummyScreenDriver(::remoting_rfb::UpdateKeeper * pupdatekeeper, ::remoting_rfb::UpdateListener * pupdatelistener, const ::i32_size & size,
   ...
   void DummyScreenDriver::initialize_dummy_screen_driver(::remoting_rfb::UpdateKeeper * pupdatekeeper, ::remoting_rfb::UpdateListener * pupdatelistener, const ::i32_size & size,
                                     unsigned int interval, ::subsystem::LogWriter * plogwriter)
   {
