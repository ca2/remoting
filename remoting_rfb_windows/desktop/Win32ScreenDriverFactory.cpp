...
#include "remoting/remoting_rfb_windows/desktop/Win32MirrorScreenDriver.h"
#include "remoting/remoting_rfb_windows/desktop/Win32ScreenDriver.h"
#include "remoting/remoting_rfb_windows/desktop/Win8ScreenDriver.h"
...
namespace remoting_rfb_windows
{
   ...
   Win32ScreenDriverFactory::Win32ScreenDriverFactory()
   {
      ...
      //::remoting_rfb_node::ServerConfig *pserverconfig) : m_pserverconfig(pserverconfig) {}

   Win32ScreenDriverFactory::~Win32ScreenDriverFactory() {}

   void Win32ScreenDriverFactory::initialize_screen_driver_factory(::remoting_rfb_node::ServerConfig *pserverconfig)
   {
   ...
   ::pointer < ::remoting_rfb::ScreenDriver > Win32ScreenDriverFactory::createScreenDriver(
   ...
   ::pointer < ::remoting_rfb::ScreenDriver > Win32ScreenDriverFactory::createStandardScreenDriver(
      ::remoting_rfb_node::Configurator * pconfigurator,
      ::remoting_rfb::UpdateKeeper *pupdatekeeper,
      ::remoting_rfb::UpdateListener *pupdatelistener,
      ::innate_subsystem::Framebuffer *pframebuffer,
   ...
   ::pointer < ::remoting_rfb::ScreenDriver > Win32ScreenDriverFactory::createMirrorScreenDriver(
      ::remoting_rfb_node::Configurator * pconfigurator,
      ::remoting_rfb::UpdateKeeper *pupdatekeeper,
      ::remoting_rfb::UpdateListener *pupdatelistener,
      ::innate_subsystem::Framebuffer *pframebuffer,
