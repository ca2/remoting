...
namespace remoting_rfb_windows
{
   ...
   void WinVideoRegionUpdaterImpl::initialize_screen_driver(::remoting_rfb_node::Configurator * pconfigurator, ::remoting_rfb::UpdateKeeper * pupdatekeeper, ::remoting_rfb::UpdateListener * pupdatelistener,
   ...
   ::remoting_rfb::Region WinVideoRegionUpdaterImpl::getVideoRegion()
   {
   ...
   ::remoting_rfb::Region WinVideoRegionUpdaterImpl::getRectsByClass(::string_array classNames)
   {
      //::array_base<HWND> hwndVector;
      //::array_base<HWND>::iterator hwndIter;
      ::remoting_rfb::Region vidRegion;
   ...
   ::remoting_rfb::Region WinVideoRegionUpdaterImpl::getRectsByCoords(::int_rectangle_array_base &rectanglea)
   {
