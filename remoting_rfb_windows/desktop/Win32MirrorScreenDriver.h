...
#include "remoting/remoting_rfb_windows/desktop/MirrorScreenDriver.h"
#include "remoting/remoting_rfb_windows/desktop/Win32ScreenDriverBaseImpl.h"

namespace remoting_rfb_windows
{

   class CLASS_DECL_REMOTING_RFB_WINDOWS Win32MirrorScreenDriver : public Win32ScreenDriverBaseImpl
   {
   public:
      //Win32MirrorScreenDriver(::remoting_rfb::UpdateKeeper * pupdatekeeper, ::remoting_rfb::UpdateListener * pupdatelistener,
      ...
      // Note: This class  is a wrapper for the MirrorScreenDriver class CLASS_DECL_REMOTING_RFB_WINDOWS and then
      // only MirrorScreenDriver can provide appropriate thread safety for the ::remoting_rfb::ScreenDriver functions.
