...
namespace remoting_rfb_windows
{
   ...
   const ::remoting_rfb::CursorShape *Win8CursorShape::getCursorShape() const
   {
      if (getIsVisible())
      {
   ...
   ::remoting_rfb::CursorShape *Win8CursorShape::getCursorShapeForWriting() { return &m_cursorshape; }
