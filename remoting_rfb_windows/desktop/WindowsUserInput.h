...
//#include "remoting/remoting_rfb_windows/desktop/WindowsClipboard.h"
...
namespace remoting_rfb_windows
{
   ...
   class CLASS_DECL_REMOTING_RFB_WINDOWS WindowsUserInput :
   ...
   public:
      ...
      virtual void getApplicationRegion(const ::process_identifier & processidentifier, ::remoting_rfb::Region & region);
