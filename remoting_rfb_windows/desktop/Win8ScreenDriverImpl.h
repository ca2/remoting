...
namespace remoting_rfb_windows
{
   ...
   class CLASS_DECL_REMOTING_RFB_WINDOWS Win8ScreenDriverImpl :
   ...
   public:
      ...
      //Win8ScreenDriverImpl(::subsystem::LogWriter * plogwriter, ::remoting_rfb::UpdateKeeper *pupdatekeeper,
      ...
      virtual void initialize_win8_screen_driver_impl(::subsystem::LogWriter * plogwriter, ::remoting_rfb::UpdateKeeper *pupdatekeeper,
                           lockable_critical_section *pcriticalsectionFramebuffer, ::remoting_rfb::UpdateListener *pupdatelistener,
                           bool detectionEnabled = false);
      ...
      void updateCursorShape(::remoting_rfb::CursorShape *dst);
   ...
   private:
      ...
      virtual void onFramebufferUpdate(const ::remoting_rfb::Region & regionChanged);
