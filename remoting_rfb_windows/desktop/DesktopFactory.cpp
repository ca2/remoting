...
#include "remoting/remoting_rfb_windows/desktop/DesktopClientImpl.h"
...
namespace remoting_rfb_windows
{
   ...
   ::pointer < ::remoting_rfb::Desktop > DesktopFactory::createDesktop(
      ...
      ::remoting_rfb::AbnormDeskTermListener *pdesktermlistenerExternal,
