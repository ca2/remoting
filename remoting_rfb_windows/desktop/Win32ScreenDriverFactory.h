...
namespace remoting_rfb_windows
{
   ...
   {
   public:
      // The factory stores pointer to a ::remoting_rfb_node::ServerConfig object and will use it on
      // createScreenDriver() function calls.
      //Win32ScreenDriverFactory(::remoting_rfb_node::ServerConfig *pserverconfig);
      Win32ScreenDriverFactory();
      ~Win32ScreenDriverFactory() override;

      void initialize_screen_driver_factory(::remoting_rfb_node::ServerConfig *pserverconfig) override;
   ...
   private:
      virtual ::pointer < ::remoting_rfb::ScreenDriver > createStandardScreenDriver(
      ::remoting_rfb_node::Configurator * pconfigurator,
      ::remoting_rfb::UpdateKeeper * pupdatekeeper,
      ::remoting_rfb::UpdateListener * pupdatelistener,
      ::innate_subsystem::Framebuffer *pframebuffer,
      ...
      virtual ::pointer < ::remoting_rfb::ScreenDriver > createMirrorScreenDriver(
      ::remoting_rfb_node::Configurator * pconfigurator,
      ::remoting_rfb::UpdateKeeper * pupdatekeeper,
      ::remoting_rfb::UpdateListener * pupdatelistener,
      ::innate_subsystem::Framebuffer *pframebuffer,
