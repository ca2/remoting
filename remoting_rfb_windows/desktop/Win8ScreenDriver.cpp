...
namespace remoting_rfb_windows
{
   ...
   // Win8ScreenDriver::Win8ScreenDriver(::remoting_rfb::UpdateKeeper * pupdatekeeper, ::remoting_rfb::UpdateListener * pupdatelistener,
...
//      critical_section_lock al(&m_drvImplMutex);
   ...
   void Win8ScreenDriver::initialize_screen_driver(::remoting_rfb_node::Configurator * pconfigurator,
      ::remoting_rfb::UpdateKeeper * pupdatekeeper, ::remoting_rfb::UpdateListener * pupdatelistener,
   ...
   const ::remoting_rfb::CursorShape *Win8ScreenDriver::getCursorShape() { return &m_cursorshape; }
