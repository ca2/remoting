...
//   }
   ...
   void UpdateRequestSender::setOutput(::remoting_rfb::RfbOutputGate* output)
   {
      {
   ...
   {
      ::remoting_rfb::RfbOutputGate* output = getOutput();
   ...
   ::remoting_rfb::RfbOutputGate* UpdateRequestSender::getOutput()
   {
      critical_section_lock al(&m_outputLock);
