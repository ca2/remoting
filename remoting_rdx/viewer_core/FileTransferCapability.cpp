...
namespace remoting_rfb_client
{
   ...
   namespace file_transfer
   {
      ...
      void FileTransferCapability::setOutput(::remoting_rfb::RfbOutputGate *output)
      {
         m_ftRequestSender.setOutput(output);
      }

      ::remoting_rfb::file_transfer::FileTransferCore *FileTransferCapability::getCore()
      {
         return &m_ftCore;
      }

      void FileTransferCapability::setInterface(::remoting_rfb::file_transfer::FileTransferInterface *ftInterface)
      {
