...
namespace remoting_rfb_client
{
   ...
   void RfbSetPixelFormatClientMessage::send(::remoting_rfb::RfbOutputGate *prfboutputgate)
   {
      critical_section_lock al(prfboutputgate);
      prfboutputgate->writeUInt8(::remoting_rfb::ClientMsgDefs::SET_PIXEL_FORMAT);
      // padding 3 bytes
