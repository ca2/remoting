...
namespace remoting_rfb_client
{
   ...
   {
      m_encoding = ::remoting_rfb::EncodingDefs::ZRLE;
   }
   ...
   void ZrleDecoder::decode(::remoting_rfb::RfbInputGate *pinput,
   ...
   void ZrleDecoder::readAndInflate(::remoting_rfb::RfbInputGate *pinput, size_t maximalUnpackedSize)
   {
