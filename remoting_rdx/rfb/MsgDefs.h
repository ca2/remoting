...
{
   class CLASS_DECL_REMOTING_RDX ClientMsgDefs
   {
   public:
   ...
   class CLASS_DECL_REMOTING_RDX ServerMsgDefs
   {
   public:
   ...
   class CLASS_DECL_REMOTING_RDX Utf8CutTextDefs
   {
   public:
   ...
   class CLASS_DECL_REMOTING_RDX EchoExtensionDefs
   {
   public:
