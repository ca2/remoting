...
namespace remoting_rfb
{
   ...
   class CLASS_DECL_REMOTING_RDX  UserInputClient :
   ...
   public:
      ...
      virtual void initialize_user_input_client(::remoting_rfb_node::Configurator * pconfigurator, BlockingGate *pblockinggate, DesktopSrvDispatcher * pdispatcher, ::subsystem::ClipboardListener *pclipboardlistener);
