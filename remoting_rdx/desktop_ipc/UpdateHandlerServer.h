...
namespace remoting_rfb
{
   ...
   class CLASS_DECL_REMOTING_RDX  UpdateHandlerServer :
   ...
   public:
      ...
      //UpdateHandlerServer(::remoting_rfb_node::Configurator *pconfigurator, BlockingGate *pblockinggate, DesktopSrvDispatcher * pdispatcher,
      ...
      virtual void initialize_update_handler_server(::remoting_rfb_node::Configurator *pconfigurator, BlockingGate *pblockinggate, DesktopSrvDispatcher * pdispatcher,
                    // AnEventListener *extTerminationListener,
                    const ::procedure &procedureTermination, ::subsystem::LogWriter * plogwriter);
