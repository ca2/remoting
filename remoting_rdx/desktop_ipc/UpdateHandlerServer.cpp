...
namespace remoting_rfb
{
   ...
   // UpdateHandlerServer::UpdateHandlerServer(::remoting_rfb_node::Configurator *pconfigurator, BlockingGate *pblockinggate, DesktopSrvDispatcher * pdispatcher,
   ...
   void UpdateHandlerServer::initialize_update_handler_server(::remoting_rfb_node::Configurator *pconfigurator, BlockingGate *pblockinggate, DesktopSrvDispatcher * pdispatcher,
              // AnEventListener *extTerminationListener,
