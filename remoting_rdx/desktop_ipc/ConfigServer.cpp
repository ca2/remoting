...
namespace remoting_rfb
{
   ...
   void ConfigServer::initialize_config_server(::remoting_rfb_node::Configurator * pconfigurator, DesktopSrvDispatcher *pdispatcher, ::subsystem::LogWriter * plogwriter)
   {
