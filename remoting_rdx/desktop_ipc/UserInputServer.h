...
namespace remoting_rfb
{
   ...
   class CLASS_DECL_REMOTING_RDX  UserInputServer : public DesktopServerProto, public ClientListener, public ::subsystem::ClipboardListener
   {
   public:
      UserInputServer(::remoting_rfb_node::Configurator * pconfigurator, BlockingGate *pblockinggate, DesktopSrvDispatcher * pdispatcher,
