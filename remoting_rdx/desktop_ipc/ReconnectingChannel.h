...
namespace remoting_rfb
{
   ...
   class CLASS_DECL_REMOTING_RDX  ReconnectingChannel : public Channel
   {
   public:
      ...
      class CLASS_DECL_REMOTING_RDX  ::time m_timeTimeout;
      ...
      ReconnectingChannel();
      ReconnectingChannel(const class CLASS_DECL_REMOTING_RDX  ::time & timeTimeout, ::subsystem::LogWriter * plogwriter);
      ~ReconnectingChannel() override;


      virtual void initialize_reconnecting_channel(const class CLASS_DECL_REMOTING_RDX  ::time & timeTimeout, ::subsystem::LogWriter * plogwriter);
