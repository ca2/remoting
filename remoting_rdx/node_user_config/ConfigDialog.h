...
{
   class CLASS_DECL_REMOTING_RDX ConfigDialog : virtual public ::innate_subsystem::Dialog
   {
   public:
      ConfigDialog(Configurator * pconfigurator, ::remoting_rfb_node::ControlCommand *reloadConfigCommand);
      ...
      void setConfigReloadCommand(::remoting_rfb_node::ControlCommand *command);
   ...
   protected:
      ...
      ::remoting_rfb_node::ServerConfigDialog m_serverConfigDialog;
      ...
      ::pointer < ::remoting_rfb_node::ControlCommand > m_pcontrolcommandReloadConfig;
