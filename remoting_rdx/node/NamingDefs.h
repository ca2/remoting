...
namespace remoting_rfb_node
{
   ...
   class CLASS_DECL_REMOTING_RDX NamingDefs
   {
   public:
      static ::string_literal MIRROR_DRIVER_MESSAGE_WINDOW_CLASS_NAME;
   };

   class CLASS_DECL_REMOTING_RDX ProductNames
   {
   public:
   ...
   class CLASS_DECL_REMOTING_RDX RegistryPaths
   {
   public:
   ...
   class CLASS_DECL_REMOTING_RDX WindowNames
   {
   public:
      static ::string_literal WINDOW_CLASS_NAME;
   };

   class CLASS_DECL_REMOTING_RDX LogNames
   {
   public:
    ...
    class CLASS_DECL_REMOTING_RDX ClipboardNames
   {
    public:
      static ::string_literal CLIPBOARD_WIN_CLASS_NAME;
    };

   class CLASS_DECL_REMOTING_RDX ServiceNames
   {
   public:
   ...
   class CLASS_DECL_REMOTING_RDX ServerApplicationNames
   {
   public:
   ...
   class CLASS_DECL_REMOTING_RDX HookDefinitions
   {
   public:
   ...
   class CLASS_DECL_REMOTING_RDX DefaultNames
   {
   public:
      static ::string_literal DEFAULT_COMPUTER_NAME;
   };

   class CLASS_DECL_REMOTING_RDX HttpStrings
   {
   public:
