...
#include "remoting/remoting_rfb/rfb_sconn/ClipboardExchange.h"
...
void UpdateSender::destroy()
{
   ...
   delete m_pupdatekeeper;
    ...
    void  UpdateSender::initialize_update_sender(RfbCodeRegistrator *m_prfbcoderegistrator, UpdateRequestListener *updReqListener,
                              SenderControlInformationInterface *senderControlInformation, ::remoting_rfb::RfbOutputGate *prfboutputgate,
                              int id, Desktop *desktop, ::subsystem::LogWriter * plogwriter) //:
       // , , ,
       // ,
   ...
   void UpdateSender::onRequest(::u32 reqCode, ::remoting_rfb::RfbInputGate *input)
   {
   ...
   void UpdateSender::readUpdateRequest(::remoting_rfb::RfbInputGate *io)
   {
   ...
   void UpdateSender::readSetPixelFormat(::remoting_rfb::RfbInputGate *io)
   {
   ...
   void UpdateSender::readSetEncodings(::remoting_rfb::RfbInputGate *io)
   {
   ...
   void UpdateSender::readVideoFreeze(::remoting_rfb::RfbInputGate *io) { setVideoFrozen(io->readUInt8() != 0); }
