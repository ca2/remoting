...
namespace remoting_rfb
{
   ...
   // This class CLASS_DECL_REMOTING_RDX  calculates actual view port rectangle.
   // Typical usage:
   // // Initialisation
   ...
   class CLASS_DECL_REMOTING_RDX  Viewport :
   ...
   public:
      ...
      void initDesktopInterface(::remoting_rfb::Desktop *desktop);
      ...
      void getApplicationRegion(::remoting_rfb::Region & region);
