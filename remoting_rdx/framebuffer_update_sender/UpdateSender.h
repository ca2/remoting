...
namespace remoting_rfb
{
   ...
   class CLASS_DECL_REMOTING_RDX  UpdateSender : public ::subsystem::Thread, public RfbDispatcherListener
   {
   public:
      ...
      // EncodeOptions class CLASS_DECL_REMOTING_RDX  maintain the configuration of encoders and
