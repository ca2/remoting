...
#include "remoting/remoting_rfb/file_transfer_node/FileTransferRequestHandler.h"
...
{
   RfbClient::RfbClient(::remoting_rfb_node::Configurator * pconfigurator,
...
void RfbClient::destroy()
{
   ...
   public:
      ...
      ::pointer < ::remoting_rfb::RfbInputGate > m_prfbinputgate;
   ...
   void RfbClient::onThreadMain()
   {
      ...
      //
      // ::remoting_rfb::RfbOutputGate m_prfpoutputgate(&sockStream);
      // BufferedInputStream bufInput(&sockStream);
      // ::remoting_rfb::RfbInputGate input(&bufInput);
