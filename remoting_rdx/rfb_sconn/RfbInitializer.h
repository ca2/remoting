...
namespace remoting_rfb
{
   ...
   public:
      ...
      virtual void initialize_rfb_initializer(::remoting_rfb_node::Configurator * pconfigurator, Channel *pchannel, ClientAuthListener *pclientauthlistener, RfbClient *client, bool authAllowed);
