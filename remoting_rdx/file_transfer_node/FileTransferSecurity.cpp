...
namespace remoting_rfb
{
   ...
   {
//      FileTransferSecurity::FileTransferSecurity(::remoting_rfb_node::Configurator * pconfigurator, Desktop *desktop, ::subsystem::LogWriter *plogwriter)
//      :
...
//      }
   ...
   void FileTransferSecurity::initialize_file_transfer_security(::remoting_rfb_node::Configurator * pconfigurator, Desktop *desktop, ::subsystem::LogWriter *plogwriter)
   {
      m_plogwriter = plogwriter;
      m_pconfigurator = pconfigurator;
      m_pdesktop = desktop;
