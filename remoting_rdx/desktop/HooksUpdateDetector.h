...
//#ifdef Wi
#ifdef WINDOWS
namespace remoting_rfb { class HookInstaller; }
namespace subsystem_windows { class MessageWindow; }
#endif
...
namespace remoting_rfb
{
   ...
   class CLASS_DECL_REMOTING_RDX HooksUpdateDetector :
   ...
   //protected:
      ...
      ///
#ifdef WINDOWS
      ::pointer < ::remoting_rfb::HookInstaller > m_phookinstaller;
