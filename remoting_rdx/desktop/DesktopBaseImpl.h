...
namespace remoting_rfb
{
   ...
   // This class  is a base class CLASS_DECL_REMOTING_RDX for different implemetations of desktops
   class CLASS_DECL_REMOTING_RDX DesktopBaseImpl :
   ...
   public:
      ...
      // A derived class CLASS_DECL_REMOTING_RDX thread control.
