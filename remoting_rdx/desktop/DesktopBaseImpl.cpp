...

{
   ...
   void DesktopBaseImpl::initialize_desktop_base_impl(::remoting_rfb_node::Configurator * pconfigurator, ::subsystem::ClipboardListener *pclipboardlistenerExternal, UpdateSendingListener *pupdatesendinglistenerExternal,
                AbnormDeskTermListener *pdesktermlistenerExternal, ::subsystem::LogWriter * plogwriter)
   {
   ...
   void DesktopBaseImpl::onConfigReload(::remoting_rfb_node::ServerConfig *serverConfig) { applyNewConfiguration(); }
