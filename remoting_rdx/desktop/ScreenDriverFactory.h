...

{
   ...
   class CLASS_DECL_REMOTING_RDX ScreenDriverFactory :
   ...
   public:
      ...
      virtual void initialize_screen_driver_factory(::remoting_rfb_node::ServerConfig *pserverconfig);

      virtual ::pointer < ::remoting_rfb::ScreenDriver > createScreenDriver(
