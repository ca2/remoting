...
namespace remoting_rfb
{
   ...
   // The class CLASS_DECL_REMOTING_RDX determines an optimal way by oneself dynamically.
   class CLASS_DECL_REMOTING_RDX GrabOptimizator :
   ...
   public:
      ...
      bool grab(const ::remoting_rfb::Region & regionGrab, ScreenDriver *grabber);
