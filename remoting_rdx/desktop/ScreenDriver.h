...
namespace remoting_rfb
{
   ...
   // frame buffer.
   class CLASS_DECL_REMOTING_RDX ScreenDriver :
   ...
   public:
      ...
      virtual void initialize_screen_driver(::remoting_rfb_node::Configurator * pconfigurator, UpdateKeeper * pupdatekeeper, UpdateListener * pupdatelistener,
      ...
      virtual const ::remoting_rfb::CursorShape *getCursorShape() = 0;
      ...
      virtual ::remoting_rfb::Region getVideoRegion() = 0;
   };
