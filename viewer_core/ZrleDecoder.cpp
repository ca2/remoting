...
size_t ZrleDecoder::getMaxSizeOfRectangle(const ::int_rectangle &  dstRect)
{
  size_t widthCount = (dstRect.width() + TILE_SIZE - 1) / TILE_SIZE;
  size_t heightCount = (dstRect.height() + TILE_SIZE - 1) / TILE_SIZE;
